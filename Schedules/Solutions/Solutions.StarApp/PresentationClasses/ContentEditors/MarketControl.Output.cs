...
namespace Asa.Solutions.StarApp.PresentationClasses.ContentEditors
{
	public sealed partial class MarketControl
	{
		...
		{
			public override String OutputName => OutputControl.SlideContainer.StarInfo.Titles.Tab7SubUTitle;
			...
			public TabUOutputProcessor(MarketControl outputControl) : base(outputControl) { }
			...
			{
				var slideObject = OutputControl.SlideContainer.EditedContent.MarketState.TabU.Slide;
				...
				if (slideObject.SourceSlideMasters.ContainsKey(SlideSettingsManager.Instance.SlideSettings.Format))
				{
					...
					var targetSlideMaster = OutputControl.SlideContainer.StarInfo.MarketConfiguration.PartUSlides.Slides
		...
		{
			public override String OutputName => OutputControl.SlideContainer.StarInfo.Titles.Tab7SubVTitle;
			...
			public TabVOutputProcessor(MarketControl outputControl) : base(outputControl) { }
			...
			public override OutputItem GetOutputItem()
			{
				var slideObject = OutputControl.SlideContainer.EditedContent.MarketState.TabV.Slide;

				if (slideObject.SourceSlideMasters.ContainsKey(SlideSettingsManager.Instance.SlideSettings.Format))
				{
					var slideMasterName = slideObject.SourceSlideMasters[SlideSettingsManager.Instance.SlideSettings.Format];
					var targetSlideMaster = OutputControl.SlideContainer.StarInfo.MarketConfiguration.PartVSlides.Slides
						.FirstOrDefault(slideMaster =>
							String.Equals(slideMaster.Name, slideMasterName, StringComparison.OrdinalIgnoreCase));
		...
		{
			public override String OutputName => OutputControl.SlideContainer.StarInfo.Titles.Tab7SubWTitle;
			...
			public TabWOutputProcessor(MarketControl outputControl) : base(outputControl) { }
			...
			public override OutputItem GetOutputItem()
			{
				var slideObject = OutputControl.SlideContainer.EditedContent.MarketState.TabW.Slide;

				if (slideObject.SourceSlideMasters.ContainsKey(SlideSettingsManager.Instance.SlideSettings.Format))
				{
					var slideMasterName = slideObject.SourceSlideMasters[SlideSettingsManager.Instance.SlideSettings.Format];
					var targetSlideMaster = OutputControl.SlideContainer.StarInfo.MarketConfiguration.PartWSlides.Slides
						.FirstOrDefault(slideMaster =>
							String.Equals(slideMaster.Name, slideMasterName, StringComparison.OrdinalIgnoreCase));
