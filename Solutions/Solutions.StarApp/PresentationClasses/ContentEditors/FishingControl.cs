...
namespace Asa.Solutions.StarApp.PresentationClasses.ContentEditors
{
	...
	public sealed partial class FishingControl : StarAppControl, IStarAppSlide
	{
		...
		public FishingControl(BaseStarAppContainer slideContainer) : base(slideContainer)
		{
			...
			xtraTabPageA.Text = SlideContainer.StarInfo.Titles.Tab3SubATitle;
			xtraTabPageB.Text = SlideContainer.StarInfo.Titles.Tab3SubBTitle;
			xtraTabPageC.Text = SlideContainer.StarInfo.Titles.Tab3SubCTitle;
		...
		private void OnSelectedPageChanged(object sender, TabPageChangedEventArgs e)
		{
			...
			{
				case 0:
					pbLogoRight.Image = SlideContainer.StarInfo.Tab3SubARightLogo;
					pbLogoFooter.Image = SlideContainer.StarInfo.Tab3SubAFooterLogo;
					break;
				case 1:
					pbLogoRight.Image = SlideContainer.StarInfo.Tab3SubBRightLogo;
					pbLogoFooter.Image = SlideContainer.StarInfo.Tab3SubBFooterLogo;
					break;
				case 2:
					pbLogoRight.Image = SlideContainer.StarInfo.Tab3SubCRightLogo;
					pbLogoFooter.Image = SlideContainer.StarInfo.Tab3SubCFooterLogo;
					break;
			}
		}
