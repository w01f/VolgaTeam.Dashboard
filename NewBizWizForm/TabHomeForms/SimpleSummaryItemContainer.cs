...
namespace NewBizWizForm.TabHomeForms
{
    ...
    {
        private List<SimpleSummaryItemControl> _itemsCollection = new List<SimpleSummaryItemControl>();
        ...
        public bool ItemsComplited
        {
            get
            {
                return _itemsCollection.Where(x => x.Complited).Count() == _itemsCollection.Count;
            }
        }
        ...
        public void LoadItems()
        {
            foreach (SimpleSummaryItemControl item in _itemsCollection)
                this.OutputContainer.DeleteItem(item.OutputItem);
            _itemsCollection.Clear();
            pnMain.Controls.Clear();
            if (ConfigurationClasses.ViewSettingsManager.Instance.SimpleSummaryState.ItemsState.Count > 0)
            {
                foreach (ConfigurationClasses.SimpleSummaryItemState itemState in ConfigurationClasses.ViewSettingsManager.Instance.SimpleSummaryState.ItemsState)
                {
                    SimpleSummaryItemControl item = new SimpleSummaryItemControl(this);
            ...
            {
                SimpleSummaryItemControl firstItem = new SimpleSummaryItemControl(this);
                firstItem.ItemNumber = _itemsCollection.Count() + 1;
                _itemsCollection.Add(firstItem);
                pnMain.Controls.Add(firstItem);
                SimpleSummaryItemControl secondItem = new SimpleSummaryItemControl(this);
        ...
        {
            ConfigurationClasses.ViewSettingsManager.Instance.SimpleSummaryState.ItemsState.Clear();
            foreach (SimpleSummaryItemControl item in _itemsCollection)
            {
                ConfigurationClasses.SimpleSummaryItemState itemState = new ConfigurationClasses.SimpleSummaryItemState();
                ...
                ConfigurationClasses.ViewSettingsManager.Instance.SimpleSummaryState.ItemsState.Add(itemState);
            }
            ConfigurationClasses.ViewSettingsManager.Instance.SimpleSummaryState.ItemsState.Sort((x, y) => x.Order.CompareTo(y.Order));
        }
        ...
        public void HideTotals()
        {
            foreach (SimpleSummaryItemControl item in _itemsCollection)
            {
                item.OutputItem.pnMonthly.Visible = this.TotalMonthlyValue.HasValue;
                item.OutputItem.pnTotal.Visible = this.TotalTotalValue.HasValue;
            }
        }
        ...
        public bool ShowMonthlyTotal
        {
            get
            {
                return _itemsCollection.Where(x => x.MonthlyValue.HasValue).Count() > 0;
            }
        }
        ...
        public double? TotalMonthlyValue
        {
            get
            {
                return _itemsCollection.Where(x => x.ShowMonthly).Count() > 0 ? (_itemsCollection.Sum(x => !string.IsNullOrEmpty(x.ItemTitle) && x.ShowMonthly ? x.MonthlyValue : null)) : null;
            }
        }
        ...
        public bool ShowTotalTotal
        {
            get
            {
                return _itemsCollection.Where(x => x.TotalValue.HasValue).Count() > 0;
            }
        }
        ...
        public double? TotalTotalValue
        {
            get
            {
                return _itemsCollection.Where(x => x.ShowTotal).Count() > 0 ? (_itemsCollection.Sum(x => !string.IsNullOrEmpty(x.ItemTitle) && x.ShowTotal ? x.TotalValue : null)) : null;
            }
        }
        ...
        public double OutputTotalMonthlyValue
        {
            get
            {
                return _itemsCollection.Sum(x => !string.IsNullOrEmpty(x.OutputItemTitle) && x.OutputMonthlyValue.HasValue ? x.OutputMonthlyValue.Value : 0);
            }
        }
        ...
        public double OutputTotalTotalValue
        {
            get
            {
                return _itemsCollection.Sum(x => !string.IsNullOrEmpty(x.OutputItemTitle) && x.OutputTotalValue.HasValue ? x.OutputTotalValue.Value : 0);
            }
        }
        #endregion
    }
