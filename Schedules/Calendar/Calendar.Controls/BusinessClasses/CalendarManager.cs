...
using SettingsManager = CalendarBuilder.ConfigurationClasses.SettingsManager;
...
namespace CalendarBuilder.BusinessClasses
{
	...
	public class ScheduleManager
	{
		...
		{
			var sourceSchedule = new NewBizWiz.Core.AdSchedule.Schedule(sourceSchedulePath);
	...
	public class Schedule
	{
		...
		public void ImportCalendars(NewBizWiz.Core.AdSchedule.Schedule sourceSchedule, bool buildAdvanced, bool buildGraphic, bool buildSimple)
		{
	...
	public abstract class Calendar
	{
		...
		public void ImportDays(NewBizWiz.Core.AdSchedule.Schedule sourceSchedule, bool useAdvancedStyle)
		{
			foreach (CalendarDay day in Days)
			{
