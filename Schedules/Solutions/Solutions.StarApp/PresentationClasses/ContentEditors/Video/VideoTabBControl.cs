...
namespace Asa.Solutions.StarApp.PresentationClasses.ContentEditors.Video
{
	...
	public sealed partial class VideoTabBControl : ChildTabBaseControl
	{
		...
		{
			return SlideContainer.EditedContent.VideoState.TabB.EnableOutput ?? CustomTabInfo.EnableOutput;
		}
		...
		{
			SlideContainer.EditedContent.VideoState.TabB.EnableOutput =
		...
		protected override OutputDataPackage GetOutputData()
		{
			...
			var slideHeader = (SlideContainer.EditedContent.VideoState.TabB.SlideHeader ?? CustomTabInfo.HeadersItems.FirstOrDefault(h => h.IsDefault))?.Value;
