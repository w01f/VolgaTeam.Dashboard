...
namespace OnlineScheduleBuilder
{
    public class AppManager
    {
        ...
        public static bool ProgramDataAvailable
        {
            get
            {
                return BusinessClasses.ListManager.Instance.ProductSources.Count > 0;
            }
        }

        private static void RemoveInstances()
        {
            CustomControls.ProductSummaryControl.RemoveInstance();
            CustomControls.ProductBundleControl.RemoveInstance();
            CustomControls.WebPackageControl.RemoveInstance();
        ...
        {
            MessageBox.Show(text, "Online Schedule Builder", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        }

        public static DialogResult ShowWarningQuestion(string text)
        {
            return MessageBox.Show(text, "Online Schedule Builder", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);
        }

        public static void ShowInformation(string text)
        {
            MessageBox.Show(text, "Online Schedule Builder", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
