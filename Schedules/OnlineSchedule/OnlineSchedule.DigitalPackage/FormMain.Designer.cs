namespace NewBizWiz.OnlineSchedule.DigitalPackage
{
	partial class FormMain
	{
		...
		private void InitializeComponent()
		{
			...
			this.ribbonBarDigitalPackageProducts = new DevComponents.DotNetBar.RibbonBar();
			...
			this.superTooltip.SetSuperTooltip(this.buttonItemDigitalPackageExit, new DevComponents.DotNetBar.SuperTooltipInfo("EXIT", "", "Close Application", null, null, DevComponents.DotNetBar.eTooltipColor.Gray));
			...
			// 
			this.ribbonBarDigitalPackageProducts.AutoOverflowEnabled = true;
			// 
			// 
			// 
			this.ribbonBarDigitalPackageProducts.BackgroundMouseOverStyle.CornerType = DevComponents.DotNetBar.eCornerType.Square;
			// 
			// 
			// 
			...
			// 
			// 
			this.ribbonBarDigitalPackageProducts.TitleStyle.CornerType = DevComponents.DotNetBar.eCornerType.Square;
			// 
			// 
			// 
			this.ribbonBarDigitalPackageProducts.TitleStyleMouseOver.CornerType = DevComponents.DotNetBar.eCornerType.Square;
			// 
			// itemContainerDigitalPackageProducts
			// 
			// 
			// 
			// 
			this.itemContainerDigitalPackageProducts.BackgroundStyle.CornerType = DevComponents.DotNetBar.eCornerType.Square;
			this.itemContainerDigitalPackageProducts.LayoutOrientation = DevComponents.DotNetBar.eOrientation.Vertical;
			this.itemContainerDigitalPackageProducts.Name = "itemContainerDigitalPackageProducts";
			this.itemContainerDigitalPackageProducts.SubItems.AddRange(new DevComponents.DotNetBar.BaseItem[] {
            this.buttonItemDigitalPackageProductsAdd,
            this.buttonItemDigitalPackageProductsDelete});
			// 
			// 
			// 
			this.itemContainerDigitalPackageProducts.TitleStyle.CornerType = DevComponents.DotNetBar.eCornerType.Square;
			// 
			// buttonItemDigitalPackageProductsAdd
			// 
			...
			this.ribbonPanelRateCard.TabIndex = 10;
			...
			// 
			this.ribbonTabItemDigitalPackage.Checked = true;
			...
			this.ribbonTabItemDigitalPackage.Text = "Schedule";
			// 
		...
		private DevComponents.DotNetBar.RibbonBar ribbonBarDigitalPackageProducts;
		private DevComponents.DotNetBar.ItemContainer itemContainerDigitalPackageProducts;
		private DevComponents.DotNetBar.ButtonItem buttonItemDigitalPackageProductsAdd;
		private DevComponents.DotNetBar.ButtonItem buttonItemDigitalPackageProductsDelete;
