...
{
	partial class WebPackageControl<TPartitionContet, TSchedule, TScheduleSettings, TChangeInfo>
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
			...
			this.buttonXCategory.CheckedChanged += new System.EventHandler(this.OnToggleCheckedChanged);
			// 
			// buttonXInfo
			// 
			...
			this.buttonXInfo.CheckedChanged += new System.EventHandler(this.OnToggleCheckedChanged);
			// 
			// buttonXGroup
			// 
			...
			this.buttonXGroup.CheckedChanged += new System.EventHandler(this.OnToggleCheckedChanged);
			// 
			// buttonXCPM
			// 
			...
			this.buttonXCPM.CheckedChanged += new System.EventHandler(this.OnToggleCheckedChanged);
			// 
			// buttonXProduct
			// 
			...
			this.buttonXProduct.CheckedChanged += new System.EventHandler(this.OnToggleCheckedChanged);
			// 
			// buttonXScreenshot
			// 
			...
			this.buttonXScreenshot.CheckedChanged += new System.EventHandler(this.OnToggleCheckedChanged);
			// 
			// buttonXImpressions
			// 
			...
			this.buttonXImpressions.CheckedChanged += new System.EventHandler(this.OnToggleCheckedChanged);
			// 
			// buttonXComments
			// 
			...
			this.buttonXComments.CheckedChanged += new System.EventHandler(this.OnToggleCheckedChanged);
			// 
			// buttonXInvestment
			// 
			...
			this.buttonXInvestment.CheckedChanged += new System.EventHandler(this.OnToggleCheckedChanged);
			// 
			// buttonXRate
			// 
			...
			this.buttonXRate.CheckedChanged += new System.EventHandler(this.OnToggleCheckedChanged);
			// 
			// pnFormula
			// 
			...
			// pbFormualHelp
			// 
			this.pbFormualHelp.Image = global::Asa.Online.Controls.Properties.Resources.FormulaLogo;
			...
			// pbFormula
			// 
			this.pbFormula.Image = global::Asa.Online.Controls.Properties.Resources.FormulaLogo;
			...
			this.checkEditFormulaCPM.CheckedChanged += new System.EventHandler(this.OnToggleCheckedChanged);
			// 
			...
			this.checkEditFormulaInvestment.CheckedChanged += new System.EventHandler(this.OnToggleCheckedChanged);
			// 
			...
			this.checkEditFormulaImpressions.CheckedChanged += new System.EventHandler(this.OnToggleCheckedChanged);
			// 
			// pnData
			// 
			...
			this.repositoryItemCheckEditFormula.PictureChecked = global::Asa.Online.Controls.Properties.Resources.FormulaLogo;
			this.repositoryItemCheckEditFormula.PictureUnchecked = global::Asa.Online.Controls.Properties.Resources.FormulaLogoDisabled;
			...
			this.pbDisabledOutput.Image = global::Asa.Online.Controls.Properties.Resources.DigitalPackageDisabled;
			...
			this.pbDisabledOutput.Click += new System.EventHandler(this.OnDisabledOutputClick);
			// 
			// pnHeader
			// 
