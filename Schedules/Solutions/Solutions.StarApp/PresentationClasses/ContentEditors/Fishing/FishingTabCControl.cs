...
namespace Asa.Solutions.StarApp.PresentationClasses.ContentEditors.Fishing
{
	...
	public sealed partial class FishingTabCControl : ChildTabBaseControl
	{
		...
		{
			return SlideContainer.EditedContent.FishingState.TabC.EnableOutput ?? CustomTabInfo.EnableOutput;
		}
		...
		{
			SlideContainer.EditedContent.FishingState.TabC.EnableOutput =
