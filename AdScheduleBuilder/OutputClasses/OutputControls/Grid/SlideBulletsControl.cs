...
namespace AdScheduleBuilder.OutputClasses.OutputControls
{
    ...
    public partial class SlideBulletsControl : UserControl
    {
        ...
        private bool _allowToCheckSlideOptions = false;
        ...
        public string TotalInserts
        {
            get
            {
                return checkEditTotalInserts.Checked ? checkEditTotalInserts.Text.Replace("<b>", string.Empty).Replace("</b>", string.Empty) : string.Empty;
            }
            set
            {
                checkEditTotalInserts.Text = "Total Ads: <b>" + value + "</b>";
            }
        }
        ...
        public string PageSize
        {
            get
            {
                return checkEditPageSize.Checked ? checkEditPageSize.Text.Replace("<b>", string.Empty).Replace("</b>", string.Empty) : string.Empty;
            }
            set
            {
                checkEditPageSize.Text = "Page Size: <b>" + value + "</b>";
            }
        }
        ...
        public string PercentOfPage
        {
            get
            {
                return checkEditPercentOfPage.Checked ? checkEditPercentOfPage.Text.Replace("<b>", string.Empty).Replace("</b>", string.Empty) : string.Empty;
            }
            set
            {
                checkEditPercentOfPage.Text = "% of Page: <b>" + value + "</b>";
            }
        }
        ...
        public string Dimensions
        {
            get
            {
                return checkEditDimensions.Checked ? checkEditDimensions.Text.Replace("<b>", string.Empty).Replace("</b>", string.Empty) : string.Empty;
            }
            set
            {
                checkEditDimensions.Text = "Col. x Inches: <b>" + value + "</b>";
            }
        }
        ...
        public string ColumnInches
        {
            get
            {
                return checkEditColumnInches.Checked ? checkEditColumnInches.Text.Replace("<b>", string.Empty).Replace("</b>", string.Empty) : string.Empty;
            }
            set
            {
                checkEditColumnInches.Text = "Total Col. In.: <b>" + value + "</b>";
            }
        }
        ...
        public string AvgAdCost
        {
            get
            {
                return checkEditAvgAdCost.Checked ? checkEditAvgAdCost.Text.Replace("<b>", string.Empty).Replace("</b>", string.Empty) : string.Empty;
            }
            set
            {
                checkEditAvgAdCost.Text = "BW Ad Cost: <b>" + value + "</b>";
            }
        }
        ...
        public string AvgFinalCost
        {
            get
            {
                return checkEditAvgFinalCost.Checked ? checkEditAvgFinalCost.Text.Replace("<b>", string.Empty).Replace("</b>", string.Empty) : string.Empty;
            }
            set
            {
                checkEditAvgFinalCost.Text = "Final Ad Cost: <b>" + value + "</b>";
            }
        }
        ...
        public string AvgPCI
        {
            get
            {
                return checkEditAvgPCI.Checked ? checkEditAvgPCI.Text.Replace("<b>", string.Empty).Replace("</b>", string.Empty) : string.Empty;
            }
            set
            {
                checkEditAvgPCI.Text = "Avg PCI: <b>" + value + "</b>";
            }
        }
        ...
        public string Delivery
        {
            get
            {
                return checkEditDelivery.Checked ? checkEditDelivery.Text.Replace("<b>", string.Empty).Replace("</b>", string.Empty) : string.Empty;
            }
            set
            {
                checkEditDelivery.Text = "Delivery: <b>" + value + "</b>";
            }
        }
        ...
        public string Readership
        {
            get
            {
                return checkEditReadership.Checked ? checkEditReadership.Text.Replace("<b>", string.Empty).Replace("</b>", string.Empty) : string.Empty;
            }
            set
            {
                checkEditReadership.Text = "Readership: <b>" + value + "</b>";
            }
        }
        ...
        public string TotalColor
        {
            get
            {
                return checkEditTotalColor.Checked ? checkEditTotalColor.Text.Replace("<b>", string.Empty).Replace("</b>", string.Empty) : string.Empty;
            }
            set
            {
                checkEditTotalColor.Text = "Total Color: <b>" + value + "</b>";
            }
        }
        ...
        public string Discounts
        {
            get
            {
                return checkEditTotalDiscounts.Checked ? checkEditTotalDiscounts.Text.Replace("<b>", string.Empty).Replace("</b>", string.Empty) : string.Empty;
            }
            set
            {
                if (value.Equals("$.00"))
        ...
        public string TotalFinalCost
        {
            get
            {
                return checkEditTotalFinalCost.Checked ? checkEditTotalFinalCost.Text.Replace("<b>", string.Empty).Replace("</b>", string.Empty) : string.Empty;
            }
            set
            {
                checkEditTotalFinalCost.Text = "Investment: <b>" + value + "</b>";
            }
        }
        ...
        public string TotalSquare
        {
            get
            {
                return checkEditTotalSquare.Checked ? checkEditTotalSquare.Text.Replace("<b>", string.Empty).Replace("</b>", string.Empty) : string.Empty;
            }
            set
            {
                checkEditTotalSquare.Text = "Total Inches: <b>" + value + "</b>";
            }
        }
        #endregion

        public SlideBulletsControl(OutputClasses.OutputControls.IGridOutputControl settingsContainer)
        {
            InitializeComponent();
            ...
            {
                checkEditEnableSlideBullets.Font = new System.Drawing.Font(checkEditEnableSlideBullets.Font.FontFamily, checkEditEnableSlideBullets.Font.Size - 3, checkEditEnableSlideBullets.Font.Style);
        ...
        private void checkEdit_EditValueChanging(object sender, ChangingEventArgs e)
        {
            ...
            if (((bool)e.NewValue))
            {
                ...
                {
                    AppManager.ShowWarning("You can select only up to six slide bullets.");
                    e.Cancel = true;
                }
            }
        }
