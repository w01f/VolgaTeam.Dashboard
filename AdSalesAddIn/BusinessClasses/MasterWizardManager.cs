...
namespace AdSalesAddIn.BusinessClasses
{
    class MasterWizardManager
    {
        ...
        public static string MasterWizardsFolder = string.Format(@"{0}\newlocaldirect.com\sync\Incoming\Slides\Dashboard", !string.IsNullOrEmpty(System.Environment.GetFolderPath(System.Environment.SpecialFolder.ProgramFilesX86)) ? System.Environment.GetFolderPath(System.Environment.SpecialFolder.ProgramFilesX86) : System.Environment.GetFolderPath(System.Environment.SpecialFolder.ProgramFiles));
