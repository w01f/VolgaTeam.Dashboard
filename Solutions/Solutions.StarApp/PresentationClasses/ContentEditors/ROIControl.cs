...
namespace Asa.Solutions.StarApp.PresentationClasses.ContentEditors
{
	...
	public sealed partial class ROIControl : StarAppControl, IStarAppSlide
	{
		...
		public ROIControl(BaseStarAppContainer slideContainer) : base(slideContainer)
		{
			...
			xtraTabPageA.Text = SlideContainer.StarInfo.Titles.Tab6SubATitle;
			xtraTabPageB.Text = SlideContainer.StarInfo.Titles.Tab6SubBTitle;
			xtraTabPageC.Text = SlideContainer.StarInfo.Titles.Tab6SubCTitle;
			xtraTabPageD.Text = SlideContainer.StarInfo.Titles.Tab6SubDTitle;
		...
		private void OnSelectedPageChanged(object sender, TabPageChangedEventArgs e)
		{
			...
			{
				case 0:
					pbLogoRight.Image = SlideContainer.StarInfo.Tab6SubARightLogo;
					pbLogoFooter.Image = SlideContainer.StarInfo.Tab6SubAFooterLogo;
					break;
				case 1:
					pbLogoRight.Image = SlideContainer.StarInfo.Tab6SubBRightLogo;
					pbLogoFooter.Image = SlideContainer.StarInfo.Tab6SubBFooterLogo;
					break;
				case 2:
					pbLogoRight.Image = SlideContainer.StarInfo.Tab6SubCRightLogo;
					pbLogoFooter.Image = SlideContainer.StarInfo.Tab6SubCFooterLogo;
					break;
				case 3:
					pbLogoRight.Image = SlideContainer.StarInfo.Tab6SubDRightLogo;
					pbLogoFooter.Image = SlideContainer.StarInfo.Tab6SubDFooterLogo;
					break;
			}
		}
