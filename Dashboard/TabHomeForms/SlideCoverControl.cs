	...
	public sealed partial class SlideCoverControl : SlideBaseControl
	{
		...
		private void LoadSavedState()
		{
			...
			if (string.IsNullOrEmpty(ViewSettingsManager.Instance.CoverState.SlideHeader))
			{
				...
				comboBoxEditSlideHeader.EditValue = ViewSettingsManager.Instance.CoverState.SlideHeader;
			...
			checkEditSalesRep.Checked = !String.IsNullOrEmpty(SettingsManager.Instance.SalesRep);
			...
			comboBoxEditSalesRep.EditValue = SettingsManager.Instance.SalesRep;
