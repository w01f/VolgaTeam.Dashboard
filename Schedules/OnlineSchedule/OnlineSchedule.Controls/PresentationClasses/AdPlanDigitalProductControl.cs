...
namespace NewBizWiz.OnlineSchedule.Controls.PresentationClasses
{
	...
	//public partial class AdPlanDigitalProductControl : UserControl, IAdPlanItem
	{
		...
		public void LoadProduct()
		{
			...
			textEditName.EditValue = DigitalProduct.AdPlanSettings.EditName && !String.IsNullOrEmpty(DigitalProduct.AdPlanSettings.Name) ? DigitalProduct.AdPlanSettings.Name : DigitalProduct.Name;
