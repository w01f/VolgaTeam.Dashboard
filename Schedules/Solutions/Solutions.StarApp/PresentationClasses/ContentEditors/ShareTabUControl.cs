...
namespace Asa.Solutions.StarApp.PresentationClasses.ContentEditors
{
	public partial class ShareTabUControl : ShareTabBaseControl
	{
		...
		public override void LoadData()
		{
			...
			slidesEditContainer.LoadData(ShareContentContainer.SlideContainer.EditedContent.ShareState.TabU.Slide);
			Application.DoEvents();
		...
		{
			var slideObject = ShareContentContainer.SlideContainer.EditedContent.ShareState.TabU.Slide;
			...
			if (slideObject.SourceSlideMasters.ContainsKey(SlideSettingsManager.Instance.SlideSettings.Format))
			{
				...
				var targetSlideMaster = ShareContentContainer.SlideContainer.StarInfo.ShareConfiguration.PartUSlides.Slides
