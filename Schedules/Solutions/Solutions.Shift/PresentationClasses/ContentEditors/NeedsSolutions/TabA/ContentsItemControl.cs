...
namespace Asa.Solutions.Shift.PresentationClasses.ContentEditors.NeedsSolutions.TabA
{
	public partial class ContentsItemControl : BaseTabASubControl
	{
		...
		public ContentsItemControl(NeedsSolutionsTabAControl container) : base(container)
		{
			InitializeComponent();
			...
			itemSelectorControl.Init(Container.CustomTabInfo.NeedsList, Container.CustomTabInfo.TabSelector.MaxSelectedTabs);
		...
		public override void LoadData()
		{
			...
			comboBoxEditCombo1.EditValue = SlideContainer.EditedContent.NeedsSolutionsState.TabA.Combo1 ??
				Container.CustomTabInfo.Combo1Items.FirstOrDefault(item => item.IsDefault);

			itemSelectorControl.LoadSavedState(SlideContainer.EditedContent.NeedsSolutionsState.TabA.Items);
		...
		public override void ApplyChanges()
		{
			...
			SlideContainer.EditedContent.NeedsSolutionsState.TabA.SlideHeader = slideHeaderValue != Container.CustomTabInfo.HeadersItems.FirstOrDefault(h => h.IsDefault) ?
				slideHeaderValue :
				null;

			SlideContainer.EditedContent.NeedsSolutionsState.TabA.Combo1 = Container.CustomTabInfo.Combo1Items.FirstOrDefault(h => h.IsDefault) != comboBoxEditCombo1.EditValue ?
