...
namespace MobileScheduleBuilder.BusinessClasses
{
    class OutputManager
    {
        ...
        private const string OneSheetsTemplatesFolderName = @"{0}\Mobile Slides\onesheets";
        private const string ProductSummaryTemplatesFolderName = @"{0}\Mobile Slides\summary";
        private const string ExcelTemplatesFolderName = @"{0}\newlocaldirect.com\sync\Incoming\Slides\ExcelOutput{1}\Mobile Slides"; 
        public const string ProductSummaryTemplateFileName = "mobile summary-1.ppt";
        public const string ExcelTemplateFileName = "Mobile_{0}_Output{1}.xls";
