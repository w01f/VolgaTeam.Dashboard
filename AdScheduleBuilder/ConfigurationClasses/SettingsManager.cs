...
namespace AdScheduleBuilder.ConfigurationClasses
{
    class SettingsManager
    {
        ...
        private SettingsManager()
        {
            ...
            _defaultSaveFolderPath = Path.Combine(string.Format(@"{0}\newlocaldirect.com\sync\Outgoing", System.Environment.GetFolderPath(System.Environment.SpecialFolder.ProgramFiles)), "AppID-" + this.AppID.ToString(), @"Saved_Schedules\Ad Schedule Builder");
            ...
            this.LocalSettingsPath = string.Format(@"{0}\newlocaldirect.com\xml\app\AdScheduleSetings.xml", System.Environment.GetFolderPath(System.Environment.SpecialFolder.ProgramFiles));
            this.HelpLinksPath = string.Format(@"{0}\newlocaldirect.com\app\HelpUrls\AdScheduleHelp.xml", System.Environment.GetFolderPath(System.Environment.SpecialFolder.ProgramFiles));
            this.SuccessModelsPath = string.Format(@"{0}\newlocaldirect.com\app\models\AdScheduleBuilder", System.Environment.GetFolderPath(System.Environment.SpecialFolder.ProgramFiles));
