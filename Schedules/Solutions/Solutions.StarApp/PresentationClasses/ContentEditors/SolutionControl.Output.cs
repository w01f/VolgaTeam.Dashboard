...
namespace Asa.Solutions.StarApp.PresentationClasses.ContentEditors
{
	public sealed partial class SolutionControl
	{
		...
		internal class TabAOutputProcessor : OutputProcessor
		{
			...
			{
				return new[] { new OutputConfiguration(StarAppOutputType.SolutionTabA, OutputName, 1) };
			}
		...
		internal class TabBOutputProcessor : OutputProcessor
		{
			...
			public override IList<OutputConfiguration> GetOutputConfigurations()
			{
				return new[] { new OutputConfiguration(StarAppOutputType.SolutionTabB, OutputName, 1) };
			}
		...
		internal class TabCOutputProcessor : OutputProcessor
		{
			...
			public override IList<OutputConfiguration> GetOutputConfigurations()
			{
				return new[] { new OutputConfiguration(StarAppOutputType.SolutionTabC, OutputName, 1) };
			}
		...
		internal class TabDOutputProcessor : OutputProcessor
		{
			...
			public override IList<OutputConfiguration> GetOutputConfigurations()
			{
				return new[] { new OutputConfiguration(StarAppOutputType.SolutionTabD, OutputName, 1) };
			}
