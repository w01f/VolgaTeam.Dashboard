...
{
	partial class MultiSlidesTabControl
	{
		/// <summary> 
		...
		{
			this.slidesEditContainer = new Asa.Solutions.Common.PresentationClasses.SlidesEdit.SlidesEditContainer();
			this.layoutControlItemSlidesContainer = new DevExpress.XtraLayout.LayoutControlItem();
			...
			this.layoutControl.Controls.Add(this.slidesEditContainer);
			...
			// 
			this.layoutControlItemSlidesContainer.Control = this.slidesEditContainer;
			this.layoutControlItemSlidesContainer.ControlAlignment = System.Drawing.ContentAlignment.MiddleCenter;
			...
			this.Name = "MultiSlidesTabControl";
		...
		private Common.PresentationClasses.SlidesEdit.SlidesEditContainer slidesEditContainer;
		private DevExpress.XtraLayout.LayoutControlItem layoutControlItemSlidesContainer;
	}
}
