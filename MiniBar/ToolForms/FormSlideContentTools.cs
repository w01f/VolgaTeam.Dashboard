...
{
    public partial class FormSlideContentTools : Form
    {
        public FormSlideContentTools()
        {
            InitializeComponent();
        ...
        {
            this.TopMost = false;
            InteropClasses.PowerPointHelper.Instance.AddContents();
            this.TopMost = true;
        }
        ...
        {
            this.TopMost = false;
            InteropClasses.PowerPointHelper.Instance.DeleteContents();
            this.TopMost = true;
        }
    }
}
