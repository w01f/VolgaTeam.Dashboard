namespace Asa.Media.Controls.PresentationClasses.Digital.Settings
{
	partial class DigitalProductPackageSettingsControl
	{
		...
		private  void InitializeComponent()
		{
			...
			// pbFormula
			// 
			this.pbFormula.Image = ((System.Drawing.Image)(resources.GetObject("pbFormula.Image")));
			...
			// labelControlFormula
			// 
			this.labelControlFormula.AllowHtmlString = true;
			...
			this.labelControlFormula.SuperTip = superToolTip1;
			this.labelControlFormula.TabIndex = 53;
			this.labelControlFormula.Text = "<b>Delivery Formula</b>";
			// 
			// checkEditFormulaCPM
			// 
			...
			this.checkEditFormulaCPM.SuperTip = superToolTip2;
