...
namespace Asa.Solutions.Shift.PresentationClasses.ContentEditors.Approach.TabB
{
	public partial class ItemControl : UserControl
	{
		...
		private readonly List<ApproachItemInfo> _itemInfoList = new List<ApproachItemInfo>();
		...
		public void Init(
			IList<ApproachItemInfo> itemInfoList,
			ApproachItemInfo defaultItem,
		...
		public void LoadData(ApproachState.ApproachItemState itemState)
		{
			_allowHandleEvents = false;
		...
		public ApproachState.ApproachItemState GetSavedState()
		{
			var itemState = new ApproachState.ApproachItemState();
		...
		private void OnComboEditValueChanged(object sender, EventArgs e)
		{
			...
			var itemInfo = comboBoxEditCombo.EditValue as ApproachItemInfo;
