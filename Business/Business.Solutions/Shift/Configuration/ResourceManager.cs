...
namespace Asa.Business.Solutions.Shift.Configuration
{
	public class ResourceManager
	{
		...
		public void Init(StorageDirectory dataFolder)
		{
			...
			LogoTab1SubABackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "01_starters", "subtab_a", "design_branding", "background.png" }));
			LogoTab1SubBBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "01_starters", "subtab_b", "design_branding", "background.png" }));
			LogoTab1SubCBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "01_starters", "subtab_c", "design_branding", "background.png" }));
			LogoTab1SubDBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "01_starters", "subtab_d", "design_branding", "background.png" }));
			LogoTab1SubEBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "01_starters", "subtab_e", "design_branding", "background.png" }));
			LogoTab1SubFBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "01_starters", "subtab_f", "design_branding", "background.png" }));
			LogoTab1SubGBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "01_starters", "subtab_g", "design_branding", "background.png" }));
			LogoTab1SubHBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "01_starters", "subtab_h", "design_branding", "background.png" }));
			LogoTab1SubIBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "01_starters", "subtab_i", "design_branding", "background.png" }));
			LogoTab1SubJBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "01_starters", "subtab_j", "design_branding", "background.png" }));
			LogoTab1SubUBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "01_starters", "subtab_u", "design_branding", "background.png" }));
			LogoTab1SubVBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "01_starters", "subtab_v", "design_branding", "background.png" }));
			LogoTab1SubWBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "01_starters", "subtab_w", "design_branding", "background.png" }));
			...
			LogoTab2SubABackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "02_goals", "subtab_a", "design_branding", "background.png" }));
			LogoTab2SubBBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "02_goals", "subtab_b", "design_branding", "background.png" }));
			LogoTab2SubCBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "02_goals", "subtab_c", "design_branding", "background.png" }));
			LogoTab2SubDBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "02_goals", "subtab_d", "design_branding", "background.png" }));
			LogoTab2SubEBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "02_goals", "subtab_e", "design_branding", "background.png" }));
			LogoTab2SubFBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "02_goals", "subtab_f", "design_branding", "background.png" }));
			LogoTab2SubGBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "02_goals", "subtab_g", "design_branding", "background.png" }));
			LogoTab2SubHBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "02_goals", "subtab_h", "design_branding", "background.png" }));
			LogoTab2SubIBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "02_goals", "subtab_i", "design_branding", "background.png" }));
			LogoTab2SubJBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "02_goals", "subtab_j", "design_branding", "background.png" }));
			LogoTab2SubUBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "02_goals", "subtab_u", "design_branding", "background.png" }));
			LogoTab2SubVBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "02_goals", "subtab_v", "design_branding", "background.png" }));
			LogoTab2SubWBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "02_goals", "subtab_w", "design_branding", "background.png" }));
			...
			LogoTab3SubABackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "03_market_opportunity", "subtab_a", "design_branding", "background.png" }));
			LogoTab3SubBBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "03_market_opportunity", "subtab_b", "design_branding", "background.png" }));
			LogoTab3SubCBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "03_market_opportunity", "subtab_c", "design_branding", "background.png" }));
			LogoTab3SubDBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "03_market_opportunity", "subtab_d", "design_branding", "background.png" }));
			LogoTab3SubEBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "03_market_opportunity", "subtab_e", "design_branding", "background.png" }));
			LogoTab3SubFBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "03_market_opportunity", "subtab_f", "design_branding", "background.png" }));
			LogoTab3SubGBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "03_market_opportunity", "subtab_g", "design_branding", "background.png" }));
			LogoTab3SubHBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "03_market_opportunity", "subtab_h", "design_branding", "background.png" }));
			LogoTab3SubIBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "03_market_opportunity", "subtab_i", "design_branding", "background.png" }));
			LogoTab3SubJBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "03_market_opportunity", "subtab_j", "design_branding", "background.png" }));
			LogoTab3SubUBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "03_market_opportunity", "subtab_u", "design_branding", "background.png" }));
			LogoTab3SubVBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "03_market_opportunity", "subtab_v", "design_branding", "background.png" }));
			LogoTab3SubWBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "03_market_opportunity", "subtab_w", "design_branding", "background.png" }));
			...
			#region Tab 4
			LogoTab4SubARightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_a", "design_branding", "4a_right.png" }));
			LogoTab4SubAFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_a", "design_branding", "4a_footer.png" }));
			LogoTab4SubBRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_b", "design_branding", "4b_right.png" }));
			LogoTab4SubBFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_b", "design_branding", "4b_footer.png" }));
			LogoTab4SubCRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_c", "design_branding", "4c_right.png" }));
			LogoTab4SubCFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_c", "design_branding", "4c_footer.png" }));
			LogoTab4SubDRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_d", "design_branding", "4d_right.png" }));
			LogoTab4SubDFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_d", "design_branding", "4d_footer.png" }));
			LogoTab4SubERightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_e", "design_branding", "4e_right.png" }));
			LogoTab4SubEFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_e", "design_branding", "4e_footer.png" }));
			LogoTab4SubFRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_f", "design_branding", "4f_right.png" }));
			LogoTab4SubFFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_f", "design_branding", "4f_footer.png" }));
			LogoTab4SubGRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_g", "design_branding", "4g_right.png" }));
			LogoTab4SubGFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_g", "design_branding", "4g_footer.png" }));
			LogoTab4SubHRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_h", "design_branding", "4h_right.png" }));
			LogoTab4SubHFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_h", "design_branding", "4h_footer.png" }));
			LogoTab4SubIRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_i", "design_branding", "4i_right.png" }));
			LogoTab4SubIFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_i", "design_branding", "4i_footer.png" }));
			LogoTab4SubJRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_j", "design_branding", "4j_right.png" }));
			LogoTab4SubJFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_j", "design_branding", "4j_footer.png" }));
			LogoTab4SubURightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_u", "design_branding", "4u_right.png" }));
			LogoTab4SubUFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_u", "design_branding", "4u_footer.png" }));
			LogoTab4SubVRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_v", "design_branding", "4v_right.png" }));
			LogoTab4SubVFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_v", "design_branding", "4v_footer.png" }));
			LogoTab4SubWRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_w", "design_branding", "4w_right.png" }));
			LogoTab4SubWFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_w", "design_branding", "4w_footer.png" }));

			LogoTab4SubABackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_a", "design_branding", "background.png" }));
			LogoTab4SubBBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_b", "design_branding", "background.png" }));
			LogoTab4SubCBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_c", "design_branding", "background.png" }));
			LogoTab4SubDBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_d", "design_branding", "background.png" }));
			LogoTab4SubEBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_e", "design_branding", "background.png" }));
			LogoTab4SubFBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_f", "design_branding", "background.png" }));
			LogoTab4SubGBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_g", "design_branding", "background.png" }));
			LogoTab4SubHBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_h", "design_branding", "background.png" }));
			LogoTab4SubIBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_i", "design_branding", "background.png" }));
			LogoTab4SubJBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_j", "design_branding", "background.png" }));
			LogoTab4SubUBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_u", "design_branding", "background.png" }));
			LogoTab4SubVBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_v", "design_branding", "background.png" }));
			LogoTab4SubWBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_w", "design_branding", "background.png" }));

			Tab4PartUSlidesFolder = new StorageDirectory(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_u" }));
			Tab4PartVSlidesFolder = new StorageDirectory(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_v" }));
			Tab4PartWSlidesFolder = new StorageDirectory(dataFolder.RelativePathParts.Merge(new[] { "04_our_partnership", "subtab_w" }));
			#endregion

			#region Tab 5
			LogoTab5SubARightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_a", "design_branding", "5a_right.png" }));
			LogoTab5SubAFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_a", "design_branding", "5a_footer.png" }));
			LogoTab5SubBRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_b", "design_branding", "5b_right.png" }));
			LogoTab5SubBFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_b", "design_branding", "5b_footer.png" }));
			LogoTab5SubCRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_c", "design_branding", "5c_right.png" }));
			LogoTab5SubCFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_c", "design_branding", "5c_footer.png" }));
			LogoTab5SubDRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_d", "design_branding", "5d_right.png" }));
			LogoTab5SubDFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_d", "design_branding", "5d_footer.png" }));
			LogoTab5SubERightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_e", "design_branding", "5e_right.png" }));
			LogoTab5SubEFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_e", "design_branding", "5e_footer.png" }));
			LogoTab5SubFRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_f", "design_branding", "5f_right.png" }));
			LogoTab5SubFFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_f", "design_branding", "5f_footer.png" }));
			LogoTab5SubGRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_g", "design_branding", "5g_right.png" }));
			LogoTab5SubGFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_g", "design_branding", "5g_footer.png" }));
			LogoTab5SubHRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_h", "design_branding", "5h_right.png" }));
			LogoTab5SubHFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_h", "design_branding", "5h_footer.png" }));
			LogoTab5SubIRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_i", "design_branding", "5i_right.png" }));
			LogoTab5SubIFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_i", "design_branding", "5i_footer.png" }));
			LogoTab5SubJRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_j", "design_branding", "5j_right.png" }));
			LogoTab5SubJFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_j", "design_branding", "5j_footer.png" }));
			LogoTab5SubURightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_u", "design_branding", "5u_right.png" }));
			LogoTab5SubUFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_u", "design_branding", "5u_footer.png" }));
			LogoTab5SubVRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_v", "design_branding", "5v_right.png" }));
			LogoTab5SubVFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_v", "design_branding", "5v_footer.png" }));
			LogoTab5SubWRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_w", "design_branding", "5w_right.png" }));
			LogoTab5SubWFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_w", "design_branding", "5w_footer.png" }));

			LogoTab5SubABackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_a", "design_branding", "background.png" }));
			LogoTab5SubBBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_b", "design_branding", "background.png" }));
			LogoTab5SubCBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_c", "design_branding", "background.png" }));
			LogoTab5SubDBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_d", "design_branding", "background.png" }));
			LogoTab5SubEBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_e", "design_branding", "background.png" }));
			LogoTab5SubFBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_f", "design_branding", "background.png" }));
			LogoTab5SubGBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_g", "design_branding", "background.png" }));
			LogoTab5SubHBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_h", "design_branding", "background.png" }));
			LogoTab5SubIBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_i", "design_branding", "background.png" }));
			LogoTab5SubJBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_j", "design_branding", "background.png" }));
			LogoTab5SubUBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_u", "design_branding", "background.png" }));
			LogoTab5SubVBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_v", "design_branding", "background.png" }));
			LogoTab5SubWBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_w", "design_branding", "background.png" }));

			Tab5PartUSlidesFolder = new StorageDirectory(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_u" }));
			Tab5PartVSlidesFolder = new StorageDirectory(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_v" }));
			Tab5PartWSlidesFolder = new StorageDirectory(dataFolder.RelativePathParts.Merge(new[] { "05_needs_solutions", "subtab_w" }));
			#endregion

			#region Tab 6
			LogoTab6SubARightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_a", "design_branding", "6a_right.png" }));
			LogoTab6SubAFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_a", "design_branding", "6a_footer.png" }));
			LogoTab6SubBRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_b", "design_branding", "6b_right.png" }));
			LogoTab6SubBFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_b", "design_branding", "6b_footer.png" }));
			LogoTab6SubCRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_c", "design_branding", "6c_right.png" }));
			LogoTab6SubCFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_c", "design_branding", "6c_footer.png" }));
			LogoTab6SubDRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_d", "design_branding", "6d_right.png" }));
			LogoTab6SubDFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_d", "design_branding", "6d_footer.png" }));
			LogoTab6SubERightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_e", "design_branding", "6e_right.png" }));
			LogoTab6SubEFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_e", "design_branding", "6e_footer.png" }));
			LogoTab6SubFRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_f", "design_branding", "6f_right.png" }));
			LogoTab6SubFFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_f", "design_branding", "6f_footer.png" }));
			LogoTab6SubGRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_g", "design_branding", "6g_right.png" }));
			LogoTab6SubGFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_g", "design_branding", "6g_footer.png" }));
			LogoTab6SubHRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_h", "design_branding", "6h_right.png" }));
			LogoTab6SubHFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_h", "design_branding", "6h_footer.png" }));
			LogoTab6SubIRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_i", "design_branding", "6i_right.png" }));
			LogoTab6SubIFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_i", "design_branding", "6i_footer.png" }));
			LogoTab6SubJRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_j", "design_branding", "6j_right.png" }));
			LogoTab6SubJFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_j", "design_branding", "6j_footer.png" }));
			LogoTab6SubURightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_u", "design_branding", "6u_right.png" }));
			LogoTab6SubUFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_u", "design_branding", "6u_footer.png" }));
			LogoTab6SubVRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_v", "design_branding", "6v_right.png" }));
			LogoTab6SubVFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_v", "design_branding", "6v_footer.png" }));
			LogoTab6SubWRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_w", "design_branding", "6w_right.png" }));
			LogoTab6SubWFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_w", "design_branding", "6w_footer.png" }));

			LogoTab6SubABackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_a", "design_branding", "background.png" }));
			LogoTab6SubBBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_b", "design_branding", "background.png" }));
			LogoTab6SubCBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_c", "design_branding", "background.png" }));
			LogoTab6SubDBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_d", "design_branding", "background.png" }));
			LogoTab6SubEBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_e", "design_branding", "background.png" }));
			LogoTab6SubFBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_f", "design_branding", "background.png" }));
			LogoTab6SubGBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_g", "design_branding", "background.png" }));
			LogoTab6SubHBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_h", "design_branding", "background.png" }));
			LogoTab6SubIBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_i", "design_branding", "background.png" }));
			LogoTab6SubJBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_j", "design_branding", "background.png" }));
			LogoTab6SubUBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_u", "design_branding", "background.png" }));
			LogoTab6SubVBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_v", "design_branding", "background.png" }));
			LogoTab6SubWBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_w", "design_branding", "background.png" }));

			Tab6PartUSlidesFolder = new StorageDirectory(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_u" }));
			Tab6PartVSlidesFolder = new StorageDirectory(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_v" }));
			Tab6PartWSlidesFolder = new StorageDirectory(dataFolder.RelativePathParts.Merge(new[] { "06_cbc", "subtab_w" }));
			#endregion

			#region Tab 7
			LogoTab7SubARightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_a", "design_branding", "7a_right.png" }));
			LogoTab7SubAFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_a", "design_branding", "7a_footer.png" }));
			LogoTab7SubBRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_b", "design_branding", "7b_right.png" }));
			LogoTab7SubBFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_b", "design_branding", "7b_footer.png" }));
			LogoTab7SubCRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_c", "design_branding", "7c_right.png" }));
			LogoTab7SubCFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_c", "design_branding", "7c_footer.png" }));
			LogoTab7SubDRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_d", "design_branding", "7d_right.png" }));
			LogoTab7SubDFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_d", "design_branding", "7d_footer.png" }));
			LogoTab7SubERightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_e", "design_branding", "7e_right.png" }));
			LogoTab7SubEFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_e", "design_branding", "7e_footer.png" }));
			LogoTab7SubFRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_f", "design_branding", "7f_right.png" }));
			LogoTab7SubFFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_f", "design_branding", "7f_footer.png" }));
			LogoTab7SubGRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_g", "design_branding", "7g_right.png" }));
			LogoTab7SubGFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_g", "design_branding", "7g_footer.png" }));
			LogoTab7SubHRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_h", "design_branding", "7h_right.png" }));
			LogoTab7SubHFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_h", "design_branding", "7h_footer.png" }));
			LogoTab7SubIRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_i", "design_branding", "7i_right.png" }));
			LogoTab7SubIFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_i", "design_branding", "7i_footer.png" }));
			LogoTab7SubJRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_j", "design_branding", "7j_right.png" }));
			LogoTab7SubJFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_j", "design_branding", "7j_footer.png" }));
			LogoTab7SubURightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_u", "design_branding", "7u_right.png" }));
			LogoTab7SubUFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_u", "design_branding", "7u_footer.png" }));
			LogoTab7SubVRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_v", "design_branding", "7v_right.png" }));
			LogoTab7SubVFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_v", "design_branding", "7v_footer.png" }));
			LogoTab7SubWRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_w", "design_branding", "7w_right.png" }));
			LogoTab7SubWFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_w", "design_branding", "7w_footer.png" }));

			LogoTab7SubABackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_a", "design_branding", "background.png" }));
			LogoTab7SubBBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_b", "design_branding", "background.png" }));
			LogoTab7SubCBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_c", "design_branding", "background.png" }));
			LogoTab7SubDBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_d", "design_branding", "background.png" }));
			LogoTab7SubEBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_e", "design_branding", "background.png" }));
			LogoTab7SubFBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_f", "design_branding", "background.png" }));
			LogoTab7SubGBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_g", "design_branding", "background.png" }));
			LogoTab7SubHBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_h", "design_branding", "background.png" }));
			LogoTab7SubIBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_i", "design_branding", "background.png" }));
			LogoTab7SubJBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_j", "design_branding", "background.png" }));
			LogoTab7SubUBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_u", "design_branding", "background.png" }));
			LogoTab7SubVBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_v", "design_branding", "background.png" }));
			LogoTab7SubWBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_w", "design_branding", "background.png" }));

			Tab7PartUSlidesFolder = new StorageDirectory(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_u" }));
			Tab7PartVSlidesFolder = new StorageDirectory(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_v" }));
			Tab7PartWSlidesFolder = new StorageDirectory(dataFolder.RelativePathParts.Merge(new[] { "07_integrated_solution", "subtab_w" }));
			#endregion

			#region Tab 8
			LogoTab8SubARightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_a", "design_branding", "8a_right.png" }));
			LogoTab8SubAFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_a", "design_branding", "8a_footer.png" }));
			LogoTab8SubBRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_b", "design_branding", "8b_right.png" }));
			LogoTab8SubBFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_b", "design_branding", "8b_footer.png" }));
			LogoTab8SubCRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_c", "design_branding", "8c_right.png" }));
			LogoTab8SubCFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_c", "design_branding", "8c_footer.png" }));
			LogoTab8SubDRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_d", "design_branding", "8d_right.png" }));
			LogoTab8SubDFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_d", "design_branding", "8d_footer.png" }));
			LogoTab8SubERightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_e", "design_branding", "8e_right.png" }));
			LogoTab8SubEFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_e", "design_branding", "8e_footer.png" }));
			LogoTab8SubFRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_f", "design_branding", "8f_right.png" }));
			LogoTab8SubFFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_f", "design_branding", "8f_footer.png" }));
			LogoTab8SubGRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_g", "design_branding", "8g_right.png" }));
			LogoTab8SubGFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_g", "design_branding", "8g_footer.png" }));
			LogoTab8SubHRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_h", "design_branding", "8h_right.png" }));
			LogoTab8SubHFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_h", "design_branding", "8h_footer.png" }));
			LogoTab8SubIRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_i", "design_branding", "8i_right.png" }));
			LogoTab8SubIFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_i", "design_branding", "8i_footer.png" }));
			LogoTab8SubJRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_j", "design_branding", "8j_right.png" }));
			LogoTab8SubJFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_j", "design_branding", "8j_footer.png" }));
			LogoTab8SubURightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_u", "design_branding", "8u_right.png" }));
			LogoTab8SubUFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_u", "design_branding", "8u_footer.png" }));
			LogoTab8SubVRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_v", "design_branding", "8v_right.png" }));
			LogoTab8SubVFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_v", "design_branding", "8v_footer.png" }));
			LogoTab8SubWRightFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_w", "design_branding", "8w_right.png" }));
			LogoTab8SubWFooterFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_w", "design_branding", "8w_footer.png" }));

			LogoTab8SubABackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_a", "design_branding", "background.png" }));
			LogoTab8SubBBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_b", "design_branding", "background.png" }));
			LogoTab8SubCBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_c", "design_branding", "background.png" }));
			LogoTab8SubDBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_d", "design_branding", "background.png" }));
			LogoTab8SubEBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_e", "design_branding", "background.png" }));
			LogoTab8SubFBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_f", "design_branding", "background.png" }));
			LogoTab8SubGBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_g", "design_branding", "background.png" }));
			LogoTab8SubHBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_h", "design_branding", "background.png" }));
			LogoTab8SubIBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_i", "design_branding", "background.png" }));
			LogoTab8SubJBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_j", "design_branding", "background.png" }));
			LogoTab8SubUBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_u", "design_branding", "background.png" }));
			LogoTab8SubVBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_v", "design_branding", "background.png" }));
			LogoTab8SubWBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_w", "design_branding", "background.png" }));

			Tab8PartUSlidesFolder = new StorageDirectory(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_u" }));
			Tab8PartVSlidesFolder = new StorageDirectory(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_v" }));
			Tab8PartWSlidesFolder = new StorageDirectory(dataFolder.RelativePathParts.Merge(new[] { "08_investment", "subtab_w" }));
			#endregion
			...
			LogoTab9SubABackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "09_relationship_next_steps", "subtab_a", "design_branding", "background.png" }));
			LogoTab9SubBBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "09_relationship_next_steps", "subtab_b", "design_branding", "background.png" }));
			LogoTab9SubCBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "09_relationship_next_steps", "subtab_c", "design_branding", "background.png" }));
			LogoTab9SubDBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "09_relationship_next_steps", "subtab_d", "design_branding", "background.png" }));
			LogoTab9SubEBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "09_relationship_next_steps", "subtab_e", "design_branding", "background.png" }));
			LogoTab9SubFBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "09_relationship_next_steps", "subtab_f", "design_branding", "background.png" }));
			LogoTab9SubGBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "09_relationship_next_steps", "subtab_g", "design_branding", "background.png" }));
			LogoTab9SubHBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "09_relationship_next_steps", "subtab_h", "design_branding", "background.png" }));
			LogoTab9SubIBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "09_relationship_next_steps", "subtab_i", "design_branding", "background.png" }));
			LogoTab9SubJBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "09_relationship_next_steps", "subtab_j", "design_branding", "background.png" }));
			LogoTab9SubUBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "09_relationship_next_steps", "subtab_u", "design_branding", "background.png" }));
			LogoTab9SubVBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "09_relationship_next_steps", "subtab_v", "design_branding", "background.png" }));
			LogoTab9SubWBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "09_relationship_next_steps", "subtab_w", "design_branding", "background.png" }));
			...
			LogoTab10SubABackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "10_agreement_contract", "subtab_a", "design_branding", "background.png" }));
			LogoTab10SubBBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "10_agreement_contract", "subtab_b", "design_branding", "background.png" }));
			LogoTab10SubCBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "10_agreement_contract", "subtab_c", "design_branding", "background.png" }));
			LogoTab10SubDBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "10_agreement_contract", "subtab_d", "design_branding", "background.png" }));
			LogoTab10SubEBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "10_agreement_contract", "subtab_e", "design_branding", "background.png" }));
			LogoTab10SubFBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "10_agreement_contract", "subtab_f", "design_branding", "background.png" }));
			LogoTab10SubGBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "10_agreement_contract", "subtab_g", "design_branding", "background.png" }));
			LogoTab10SubHBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "10_agreement_contract", "subtab_h", "design_branding", "background.png" }));
			LogoTab10SubIBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "10_agreement_contract", "subtab_i", "design_branding", "background.png" }));
			LogoTab10SubJBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "10_agreement_contract", "subtab_j", "design_branding", "background.png" }));
			LogoTab10SubUBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "10_agreement_contract", "subtab_u", "design_branding", "background.png" }));
			LogoTab10SubVBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "10_agreement_contract", "subtab_v", "design_branding", "background.png" }));
			LogoTab10SubWBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "10_agreement_contract", "subtab_w", "design_branding", "background.png" }));
			...
			LogoTab11SubABackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "11_support_materials", "subtab_a", "design_branding", "background.png" }));
			LogoTab11SubBBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "11_support_materials", "subtab_b", "design_branding", "background.png" }));
			LogoTab11SubCBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "11_support_materials", "subtab_c", "design_branding", "background.png" }));
			LogoTab11SubDBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "11_support_materials", "subtab_d", "design_branding", "background.png" }));
			LogoTab11SubEBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "11_support_materials", "subtab_e", "design_branding", "background.png" }));
			LogoTab11SubFBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "11_support_materials", "subtab_f", "design_branding", "background.png" }));
			LogoTab11SubGBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "11_support_materials", "subtab_g", "design_branding", "background.png" }));
			LogoTab11SubHBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "11_support_materials", "subtab_h", "design_branding", "background.png" }));
			LogoTab11SubIBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "11_support_materials", "subtab_i", "design_branding", "background.png" }));
			LogoTab11SubJBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "11_support_materials", "subtab_j", "design_branding", "background.png" }));
			LogoTab11SubUBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "11_support_materials", "subtab_u", "design_branding", "background.png" }));
			LogoTab11SubVBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "11_support_materials", "subtab_v", "design_branding", "background.png" }));
			LogoTab11SubWBackgroundFile = new StorageFile(dataFolder.RelativePathParts.Merge(new[] { "11_support_materials", "subtab_w", "design_branding", "background.png" }));
