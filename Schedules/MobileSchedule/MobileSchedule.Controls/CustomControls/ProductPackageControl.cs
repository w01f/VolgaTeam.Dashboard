    ...
    public partial class ProductPackageControl : UserControl
    {
        ...
        public void LoadValues()
        {
            ...
            if (!string.IsNullOrEmpty(this.ProductPackage.SlideHeader))
                MobilePackageControl.Instance.comboBoxEditSlideHeader.EditValue = this.ProductPackage.SlideHeader;
            else
                MobilePackageControl.Instance.comboBoxEditSlideHeader.EditValue = null;
            MobilePackageControl.Instance.labelControlPresentationDate.Text = "Presentation Date: " + this.ProductPackage.Parent.PresentationDate.ToString("MM/dd/yy");
        ...
        public void UpdateView()
        {
            ...
            MobilePackageControl.Instance.labelControlPresentationDate.Visible = this.ProductPackage.ShowPresentationDate;
            if (this.ProductPackage.ShowBusinessName && this.ProductPackage.ShowDecisionMaker)
            {
                MobilePackageControl.Instance.labelControlAdvertiser.Visible = true;
                MobilePackageControl.Instance.labelControlAdvertiser.Text = "Prepared For: " + this.ProductPackage.Parent.BusinessName + "\n\n" + this.ProductPackage.Parent.DecisionMaker;
            }
            else if (!this.ProductPackage.ShowBusinessName && this.ProductPackage.ShowDecisionMaker)
            {
                MobilePackageControl.Instance.labelControlAdvertiser.Visible = true;
                MobilePackageControl.Instance.labelControlAdvertiser.Text = this.ProductPackage.Parent.DecisionMaker;
            }
            else if (this.ProductPackage.ShowBusinessName && !this.ProductPackage.ShowDecisionMaker)
            {
                MobilePackageControl.Instance.labelControlAdvertiser.Visible = true;
            ...
            {
                MobilePackageControl.Instance.labelControlAdvertiser.Visible = false;
            }
            ...
            MobilePackageControl.Instance.pictureBoxFormula.Image = this.ProductPackage.ShowCPMButton ? Properties.Resources.InvestmentLogo : Properties.Resources.InvestmentLogoGray;
            MobilePackageControl.Instance.labelControlFormula.Enabled = this.ProductPackage.ShowCPMButton;
            MobilePackageControl.Instance.checkEditFormulaCPM.Enabled = this.ProductPackage.ShowCPMButton;
            MobilePackageControl.Instance.checkEditFormulaInvestment.Enabled = this.ProductPackage.ShowCPMButton;
            MobilePackageControl.Instance.checkEditFormulaImpressions.Enabled = this.ProductPackage.ShowCPMButton;
        }
        ...
        public void SaveValues()
        {
            if (_allowToSave)
            {
                this.ProductPackage.SlideHeader = MobilePackageControl.Instance.comboBoxEditSlideHeader.EditValue != null ? MobilePackageControl.Instance.comboBoxEditSlideHeader.EditValue.ToString() : (MobilePackageControl.Instance.comboBoxEditSlideHeader.Properties.Items.Count > 0 ? MobilePackageControl.Instance.comboBoxEditSlideHeader.Properties.Items[0].ToString() : string.Empty);
                this.ProductPackage.Websites.Clear();
                if (FormMain.Instance.buttonItemMobilePackageWebsites.Checked)
                    foreach (DevExpress.XtraEditors.Controls.CheckedListBoxItem item in checkedListBoxControlWebsite.Items)
        ...
        private void ckTotalMonth_CheckedChanged(object sender, EventArgs e)
        {
            ...
            SaveCheckboxValues();
            MobilePackageControl.Instance.UpdateOutputStatus();
            MobilePackageControl.Instance.SettingsNotSaved = true;
        }
        ...
        {
            checkedListBoxControlWebsite.Enabled = FormMain.Instance.buttonItemMobilePackageWebsites.Checked;
            if (!FormMain.Instance.buttonItemMobilePackageWebsites.Checked)
            {
                checkedListBoxControlWebsite.UnCheckAll();
                checkEditCustomWebsite1.Checked = FormMain.Instance.buttonItemMobilePackageWebsites.Checked;
                checkEditCustomWebsite2.Checked = FormMain.Instance.buttonItemMobilePackageWebsites.Checked;
                checkEditCustomWebsite1.Enabled = FormMain.Instance.buttonItemMobilePackageWebsites.Checked;
                checkEditCustomWebsite2.Enabled = FormMain.Instance.buttonItemMobilePackageWebsites.Checked;
            }
            else
            {
                if (checkedListBoxControlWebsite.Items.Count > 0)
