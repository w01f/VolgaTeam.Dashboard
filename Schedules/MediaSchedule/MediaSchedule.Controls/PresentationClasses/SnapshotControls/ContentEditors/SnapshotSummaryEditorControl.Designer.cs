...
{
	sealed partial class SnapshotSummaryEditorControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
            ...
            this.bandedGridColumnTotalWeeks,
			...
			this.gridBandOtherColumns.Columns.Add(this.bandedGridColumnTotalWeeks);
			...
			this.bandedGridColumnRate.AppearanceHeader.Options.UseTextOptions = true;
			this.bandedGridColumnRate.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.bandedGridColumnRate.AppearanceHeader.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.bandedGridColumnRate.AutoFillDown = true;
			this.bandedGridColumnRate.Caption = "Weekly Cost";
			...
			this.bandedGridColumnRate.OptionsColumn.ReadOnly = true;
			this.bandedGridColumnRate.RowCount = 3;
			...
			// 
			// bandedGridColumnTotalWeeks
			// 
			this.bandedGridColumnTotalWeeks.AppearanceCell.Options.UseTextOptions = true;
			this.bandedGridColumnTotalWeeks.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.bandedGridColumnTotalWeeks.AppearanceHeader.Options.UseTextOptions = true;
			this.bandedGridColumnTotalWeeks.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.bandedGridColumnTotalWeeks.AppearanceHeader.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.bandedGridColumnTotalWeeks.AutoFillDown = true;
			this.bandedGridColumnTotalWeeks.Caption = "Total Weeks";
			this.bandedGridColumnTotalWeeks.ColumnEdit = this.repositoryItemSpinEditSpot;
			this.bandedGridColumnTotalWeeks.DisplayFormat.FormatString = "#,##0";
			this.bandedGridColumnTotalWeeks.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Custom;
			this.bandedGridColumnTotalWeeks.FieldName = "TotalWeeks";
			this.bandedGridColumnTotalWeeks.MinWidth = 85;
			this.bandedGridColumnTotalWeeks.Name = "bandedGridColumnTotalWeeks";
			this.bandedGridColumnTotalWeeks.OptionsColumn.FixedWidth = true;
			this.bandedGridColumnTotalWeeks.RowCount = 3;
			this.bandedGridColumnTotalWeeks.Visible = true;
			this.bandedGridColumnTotalWeeks.Width = 85;
			// 
			...
			this.layoutControlItemPrograms.Size = new System.Drawing.Size(977, 563);
		...
		private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn bandedGridColumnTotalWeeks;
