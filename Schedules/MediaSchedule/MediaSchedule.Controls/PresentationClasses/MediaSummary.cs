...
{
	public class MediaSummary : SummaryControl
	{
		...
		private void TrackOutput()
		{
			...
			options.Add("Slide", Controller.Instance.TabSummary.Text);
		...
		public override void UpdateOutput(bool quickLoad)
		{
			...
			FormThemeSelector.Link(Controller.Instance.SummaryTheme,
				BusinessWrapper.Instance.ThemeManager.GetThemes(MediaMetaData.Instance.DataType == MediaDataType.TV ? SlideType.TVDigitalProduct : SlideType.RadioDigitalProduct),
