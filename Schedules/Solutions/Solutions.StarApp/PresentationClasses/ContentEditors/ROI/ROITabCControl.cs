...
namespace Asa.Solutions.StarApp.PresentationClasses.ContentEditors.ROI
{
	public partial class ROITabCControl : ChildTabBaseControl
	{
		...
		public ROITabCControl(IChildTabPageContainer slideContainer, StarChildTabInfo tabInfo) : base(slideContainer, tabInfo)
		{
			InitializeComponent();
		...
		{
			return SlideContainer.EditedContent.ROIState.TabC.SlideHeader ??
		...
		{
			SlideContainer.EditedContent.ROIState.TabC.SlideHeader =
		...
		protected override OutputDataPackage GetOutputData()
		{
			...
			var slideHaeder = (SlideContainer.EditedContent.ROIState.TabC.SlideHeader ?? TabInfo.HeadersItems.FirstOrDefault(h => h.IsDefault))?.Value;
