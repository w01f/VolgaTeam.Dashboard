...
namespace Asa.Solutions.Shift.PresentationClasses.ContentEditors.Goals
{
	...
	public sealed partial class GoalsTabBControl : ChildTabBaseControl
	{
		...
		public override void LoadData()
		{
			...
			memoPopupEdit1.LoadData(SlideContainer.EditedContent.GoalsState.TabB.MemoPopup1);
			memoPopupEdit2.LoadData(SlideContainer.EditedContent.GoalsState.TabB.MemoPopup2);
			memoPopupEdit3.LoadData(SlideContainer.EditedContent.GoalsState.TabB.MemoPopup3);
		...
		public override void ApplyChanges()
		{
			...
			SlideContainer.EditedContent.GoalsState.TabB.MemoPopup1 = memoPopupEdit1.GetSelectedItem();
			SlideContainer.EditedContent.GoalsState.TabB.MemoPopup2 = memoPopupEdit2.GetSelectedItem();
			SlideContainer.EditedContent.GoalsState.TabB.MemoPopup3 = memoPopupEdit3.GetSelectedItem();
