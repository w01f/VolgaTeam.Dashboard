...
namespace Asa.Solutions.StarApp.PresentationClasses.ContentEditors.Share
{
	public partial class ShareTabDControl : ChildTabBaseControl
	{
		...
		{
			return SlideContainer.EditedContent.ShareState.TabD.EnableOutput ?? CustomTabInfo.EnableOutput;
		}
		...
		{
			SlideContainer.EditedContent.ShareState.TabD.EnableOutput =
		...
		protected override OutputDataPackage GetOutputData()
		{
			...
			var slideHeader = (SlideContainer.EditedContent.ShareState.TabD.SlideHeader ?? CustomTabInfo.HeadersItems.FirstOrDefault(h => h.IsDefault))?.Value;
