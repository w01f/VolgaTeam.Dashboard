...
namespace Asa.Solutions.Shift.PresentationClasses.ContentEditors.NeedsSolutions.TabF
{
	...
	{
		private readonly NeedsSolutionsTabFControl _container;
		...
		{
			_sourceList.Clear();
			_sourceList.AddRange(_container.CustomTabInfo.SolutionsList);
	...
	public class Item1Control : ItemControl
	{
		...
		public Item1Control(NeedsSolutionsTabFControl container) : base(container) { }
	}
	...
	public class Item2Control : ItemControl
	{
		...
		public Item2Control(NeedsSolutionsTabFControl container) : base(container) { }
	}
	...
	public class Item3Control : ItemControl
	{
		...
		public Item3Control(NeedsSolutionsTabFControl container) : base(container) { }
	}
	...
	public class Item4Control : ItemControl
	{
		...
		public Item4Control(NeedsSolutionsTabFControl container) : base(container) { }
	}
}
