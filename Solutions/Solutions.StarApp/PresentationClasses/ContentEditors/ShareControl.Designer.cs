namespace Asa.Solutions.StarApp.PresentationClasses.ContentEditors
{
	sealed partial class ShareControl
	{
        ...
        private void InitializeComponent()
        {
			...
			this.xtraTabPageC = new DevExpress.XtraTab.XtraTabPage();
			this.xtraTabPageD = new DevExpress.XtraTab.XtraTabPage();
			this.xtraTabPageE = new DevExpress.XtraTab.XtraTabPage();
			...
			// xtraTabPageC
			// 
			this.xtraTabPageC.Name = "xtraTabPageC";
			this.xtraTabPageC.Size = new System.Drawing.Size(746, 328);
			this.xtraTabPageC.Text = "Tab C";
			// 
			// xtraTabPageD
			// 
			this.xtraTabPageD.Name = "xtraTabPageD";
			this.xtraTabPageD.Size = new System.Drawing.Size(746, 328);
			this.xtraTabPageD.Text = "Tab D";
			// 
			// xtraTabPageE
			// 
			this.xtraTabPageE.Name = "xtraTabPageE";
			this.xtraTabPageE.Size = new System.Drawing.Size(746, 328);
			this.xtraTabPageE.Text = "Tab E";
			// 
			// ShareControl
			// 
		...
		private DevExpress.XtraTab.XtraTabPage xtraTabPageC;
		private DevExpress.XtraTab.XtraTabPage xtraTabPageD;
		private DevExpress.XtraTab.XtraTabPage xtraTabPageE;
	}
}
