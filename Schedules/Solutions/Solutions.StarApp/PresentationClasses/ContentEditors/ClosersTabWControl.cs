...
{
	public partial class ClosersTabWControl : ClosersTabBaseControl
	{
		public ClosersTabWControl(IClosersTabPageContainer closersContentContainer) : base(closersContentContainer)
		{
			InitializeComponent();

			slidesEditContainer.Init(ClosersContentContainer.SlideContainer.StarInfo.ClosersConfiguration.PartWSlides);
		...
		public override void LoadData()
		{
			...
			slidesEditContainer.LoadData(ClosersContentContainer.SlideContainer.EditedContent.ClosersState.TabW.Slide);
			Application.DoEvents();
		...
		#region Output
		public override string OutputName => ClosersContentContainer.SlideContainer.StarInfo.Titles.Tab11SubWTitle;

		public override OutputItem GetOutputItem()
		{
			var slideObject = ClosersContentContainer.SlideContainer.EditedContent.ClosersState.TabW.Slide;
			...
			if (slideObject.SourceSlideMasters.ContainsKey(SlideSettingsManager.Instance.SlideSettings.Format))
			{
				...
				var targetSlideMaster = ClosersContentContainer.SlideContainer.StarInfo.ClosersConfiguration.PartWSlides.Slides
