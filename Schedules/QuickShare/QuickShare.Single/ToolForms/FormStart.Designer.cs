namespace NewBizWiz.QuickShare.Single
{
    partial class FormStart
    {
        ...
        private void InitializeComponent()
        {
			...
			this.laTitle.Text = "Do you want to Create a NEW {0} QuickShare Package, or Open a Saved {0} Package?";
			...
			this.buttonXNew.Text = "New Package";
			...
			this.buttonXOpen.Text = "Open Package";
