...
namespace Asa.Solutions.StarApp.PresentationClasses.ContentEditors.ROI
{
	public partial class ROITabAControl : ChildTabBaseControl
	{
		...
		public ROITabAControl(IChildTabPageContainer slideContainer, StarChildTabInfo tabInfo) : base(slideContainer, tabInfo)
		{
			InitializeComponent();
		...
		{
			return SlideContainer.EditedContent.ROIState.TabA.SlideHeader ??
		...
		{
			SlideContainer.EditedContent.ROIState.TabA.SlideHeader =
		...
		protected override OutputDataPackage GetOutputData()
		{
			...
			var slideHeader = (SlideContainer.EditedContent.ROIState.TabA.SlideHeader ?? TabInfo.HeadersItems.FirstOrDefault(h => h.IsDefault))?.Value;
