...
namespace Asa.Solutions.StarApp.PresentationClasses.ContentEditors
{
	public partial class ClosersTabUControl : ClosersTabBaseControl
	{
		...
		public override void LoadData()
		{
			...
			slidesEditContainer.LoadData(ClosersContentContainer.SlideContainer.EditedContent.ClosersState.TabU.Slide);
			Application.DoEvents();
		...
		{
			var slideObject = ClosersContentContainer.SlideContainer.EditedContent.ClosersState.TabU.Slide;
			...
			if (slideObject.SourceSlideMasters.ContainsKey(SlideSettingsManager.Instance.SlideSettings.Format))
			{
				...
				var targetSlideMaster = ClosersContentContainer.SlideContainer.StarInfo.ClosersConfiguration.PartUSlides.Slides
