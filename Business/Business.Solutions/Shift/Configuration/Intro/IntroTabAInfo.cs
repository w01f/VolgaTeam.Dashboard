...
namespace Asa.Business.Solutions.Shift.Configuration.Intro
{
	public class IntroTabAInfo : ShiftTabWithHeaderInfo
	{
		...
		public Image Clipart2Image => _resourceManager.GraphicResources?.Tab2_A_Clipart2;
		public ClipartConfiguration Clipart2Configuration { get; private set; }

		public Image Clipart3Image => _resourceManager.GraphicResources?.Tab2_A_Clipart3;
		public ClipartConfiguration Clipart3Configuration { get; private set; }

		public Image Clipart4Image => _resourceManager.GraphicResources?.Tab2_A_Clipart4;
		public ClipartConfiguration Clipart4Configuration { get; private set; }

		public IntroTabAInfo() : base(ShiftChildTabType.A, ShiftTopTabType.Intro)
		{
		...
		public override void LoadData(XmlNode configNode, ResourceManager resourceManager)
		{
			...
			HeadersEditorConfiguration = TextEditorConfiguration.FromXml(node, "SHIFT02AHeader");
		}
	}
}
