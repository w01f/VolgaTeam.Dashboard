...
{
	[ToolboxItem(false)]
	public sealed partial class PartnershipTabAControl : ChildTabBaseControl
	{
		private PartnershipTabAInfo CustomTabInfo => (PartnershipTabAInfo)TabInfo;

		public PartnershipTabAControl(IChildTabPageContainer slideContainer, ShiftChildTabInfo tabInfo) : base(slideContainer, tabInfo)
		{
			InitializeComponent();
		...
		public override void LoadData()
		{
			...
			clipartEditContainer1.LoadData(SlideContainer.EditedContent.PartnershipState.TabA.Clipart1);
			clipartEditContainer2.LoadData(SlideContainer.EditedContent.PartnershipState.TabA.Clipart2);

			comboBoxEditSlideHeader.EditValue = SlideContainer.EditedContent.PartnershipState.TabA.SlideHeader ??
				CustomTabInfo.HeadersItems.FirstOrDefault(h => h.IsDefault);

			comboBoxEditCombo1.EditValue = SlideContainer.EditedContent.PartnershipState.TabA.Combo1 ??
										   CustomTabInfo.Combo1Items.FirstOrDefault(item => item.IsDefault);
			comboBoxEditCombo2.EditValue = SlideContainer.EditedContent.PartnershipState.TabA.Combo2 ??
										   CustomTabInfo.Combo2Items.FirstOrDefault(item => item.IsDefault);
			comboBoxEditCombo3.EditValue = SlideContainer.EditedContent.PartnershipState.TabA.Combo3 ??
										   CustomTabInfo.Combo3Items.FirstOrDefault(item => item.IsDefault);
			comboBoxEditCombo4.EditValue = SlideContainer.EditedContent.PartnershipState.TabA.Combo4 ??
										   CustomTabInfo.Combo4Items.FirstOrDefault(item => item.IsDefault);

			memoEditSubheader1.EditValue = SlideContainer.EditedContent.PartnershipState.TabA.Subheader1 ??
											CustomTabInfo.SubHeader1DefaultValue;
			memoEditSubheader2.EditValue = SlideContainer.EditedContent.PartnershipState.TabA.Subheader2 ??
											CustomTabInfo.SubHeader2DefaultValue;
			memoEditSubheader3.EditValue = SlideContainer.EditedContent.PartnershipState.TabA.Subheader3 ??
											CustomTabInfo.SubHeader3DefaultValue;
			textEditSubheader4.EditValue = SlideContainer.EditedContent.PartnershipState.TabA.Subheader4 ??
		...
		public override void ApplyChanges()
		{
			...
			SlideContainer.EditedContent.PartnershipState.TabA.Clipart1 = clipartEditContainer1.GetActiveClipartObject();
			SlideContainer.EditedContent.PartnershipState.TabA.Clipart2 = clipartEditContainer2.GetActiveClipartObject();
			...
			SlideContainer.EditedContent.PartnershipState.TabA.SlideHeader = slideHeaderValue != CustomTabInfo.HeadersItems.FirstOrDefault(h => h.IsDefault) ?
				slideHeaderValue :
				null;

			SlideContainer.EditedContent.PartnershipState.TabA.Combo1 = CustomTabInfo.Combo1Items.FirstOrDefault(h => h.IsDefault) != comboBoxEditCombo1.EditValue ?
				comboBoxEditCombo1.EditValue as ListDataItem ?? new ListDataItem { Value = comboBoxEditCombo1.EditValue as String } :
				null;
			SlideContainer.EditedContent.PartnershipState.TabA.Combo2 = CustomTabInfo.Combo2Items.FirstOrDefault(h => h.IsDefault) != comboBoxEditCombo2.EditValue ?
				comboBoxEditCombo2.EditValue as ListDataItem ?? new ListDataItem { Value = comboBoxEditCombo2.EditValue as String } :
				null;
			SlideContainer.EditedContent.PartnershipState.TabA.Combo3 = CustomTabInfo.Combo3Items.FirstOrDefault(h => h.IsDefault) != comboBoxEditCombo3.EditValue ?
				comboBoxEditCombo3.EditValue as ListDataItem ?? new ListDataItem { Value = comboBoxEditCombo3.EditValue as String } :
				null;
			SlideContainer.EditedContent.PartnershipState.TabA.Combo4 = CustomTabInfo.Combo4Items.FirstOrDefault(h => h.IsDefault) != comboBoxEditCombo4.EditValue ?
				comboBoxEditCombo4.EditValue as ListDataItem ?? new ListDataItem { Value = comboBoxEditCombo4.EditValue as String } :
				null;

			SlideContainer.EditedContent.PartnershipState.TabA.Subheader1 =
				memoEditSubheader1.EditValue as String != CustomTabInfo.SubHeader1DefaultValue
					...
					: null;
			SlideContainer.EditedContent.PartnershipState.TabA.Subheader2 =
				memoEditSubheader2.EditValue as String != CustomTabInfo.SubHeader2DefaultValue
					...
					: null;
			SlideContainer.EditedContent.PartnershipState.TabA.Subheader3 =
				memoEditSubheader3.EditValue as String != CustomTabInfo.SubHeader3DefaultValue
					...
					: null;
			SlideContainer.EditedContent.PartnershipState.TabA.Subheader4 =
		...
		{
			return SlideContainer.EditedContent.PartnershipState.TabA.EnableOutput ?? CustomTabInfo.EnableOutput;
		}

		public override void ApplyOutputEnableState(Boolean outputEnabled)
		{
			SlideContainer.EditedContent.PartnershipState.TabA.EnableOutput =
		...
		#region Output
		public override SlideType SlideType => SlideType.ShiftPartnershipA;
		...
		protected override OutputDataPackage GetOutputData()
		{
			...
			var clipart1 = SlideContainer.EditedContent.PartnershipState.TabA.Clipart1 ??
						  ImageClipartObject.FromImage(CustomTabInfo.Clipart1Image);
			if (clipart1 != null)
				outputDataPackage.ClipartItems.Add("SHIFT06ACLIPART1", clipart1);
			var clipart2 = SlideContainer.EditedContent.PartnershipState.TabA.Clipart2 ??
						   ImageClipartObject.FromImage(CustomTabInfo.Clipart2Image);
			if (clipart2 != null)
				outputDataPackage.ClipartItems.Add("SHIFT06ACLIPART2", clipart2);

			outputDataPackage.TemplateName =
				MasterWizardManager.Instance.SelectedWizard.GetShiftPartnershipFile("022_partnership_a.pptx");

			outputDataPackage.TextItems.Add("SHIFT06AHEADER".ToUpper(), (SlideContainer.EditedContent.PartnershipState.TabA.SlideHeader ?? CustomTabInfo.HeadersItems.FirstOrDefault(h => h.IsDefault))?.Value);

			outputDataPackage.TextItems.Add("SHIFT06ACOMBO1".ToUpper(), (SlideContainer.EditedContent.PartnershipState.TabA.Combo1 ?? CustomTabInfo.Combo1Items.FirstOrDefault(h => h.IsDefault))?.Value);
			outputDataPackage.TextItems.Add("SHIFT06ACOMBO2".ToUpper(), (SlideContainer.EditedContent.PartnershipState.TabA.Combo2 ?? CustomTabInfo.Combo2Items.FirstOrDefault(h => h.IsDefault))?.Value);
			outputDataPackage.TextItems.Add("SHIFT06ACOMBO3".ToUpper(), (SlideContainer.EditedContent.PartnershipState.TabA.Combo3 ?? CustomTabInfo.Combo3Items.FirstOrDefault(h => h.IsDefault))?.Value);
			outputDataPackage.TextItems.Add("SHIFT06ACOMBO4".ToUpper(), (SlideContainer.EditedContent.PartnershipState.TabA.Combo4 ?? CustomTabInfo.Combo4Items.FirstOrDefault(h => h.IsDefault))?.Value);

			outputDataPackage.TextItems.Add("SHIFT06ASUBHEADER1".ToUpper(), SlideContainer.EditedContent.PartnershipState.TabA.Subheader1 ?? CustomTabInfo.SubHeader1DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT06ASUBHEADER2".ToUpper(), SlideContainer.EditedContent.PartnershipState.TabA.Subheader2 ?? CustomTabInfo.SubHeader2DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT06ASUBHEADER3".ToUpper(), SlideContainer.EditedContent.PartnershipState.TabA.Subheader3 ?? CustomTabInfo.SubHeader3DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT06ASUBHEADER4".ToUpper(), SlideContainer.EditedContent.PartnershipState.TabA.Subheader4 ?? CustomTabInfo.SubHeader4DefaultValue);
