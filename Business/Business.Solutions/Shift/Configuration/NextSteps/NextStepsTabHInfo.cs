...
{
	public class NextStepsTabHInfo : ShiftTabWithHeaderInfo
	{
		public Image Clipart1Image => _resourceManager.GraphicResources?.Tab14_H_Clipart1;
		public ClipartConfiguration Clipart1Configuration { get; private set; }
		public Image Clipart2Image => _resourceManager.GraphicResources?.Tab14_H_Clipart2;
		public ClipartConfiguration Clipart2Configuration { get; private set; }
		public Image Clipart3Image => _resourceManager.GraphicResources?.Tab14_H_Clipart3;
		...
		public NextStepsTabHInfo() : base(ShiftChildTabType.H, ShiftTopTabType.NextSteps)
		{
		...
		public override void LoadData(XmlNode configNode, ResourceManager resourceManager)
		{
			...
			if (resourceManager.DataNextStepsPartHFile.ExistsLocal())
			{
				var document = new XmlDocument();
				document.Load(resourceManager.DataNextStepsPartHFile.LocalPath);

				var node = document.SelectSingleNode(@"/SHIFT14H");
				if (node == null) return;
				...
				Clipart1Configuration = ClipartConfiguration.FromXml(node, "SHIFT14HClipart1");
				Clipart2Configuration = ClipartConfiguration.FromXml(node, "SHIFT14HClipart2");
				Clipart3Configuration = ClipartConfiguration.FromXml(node, "SHIFT14HClipart3");

				CommonEditorConfiguration = TextEditorConfiguration.FromXml(node);
				HeadersEditorConfiguration = TextEditorConfiguration.FromXml(node, "SHIFT14HHeader");

				Combo1Configuration = TextEditorConfiguration.FromXml(node, "SHIFT14HCombo1");
				Combo2Configuration = TextEditorConfiguration.FromXml(node, "SHIFT14HCombo2");
				Combo3Configuration = TextEditorConfiguration.FromXml(node, "SHIFT14HCombo3");
				Combo4Configuration = TextEditorConfiguration.FromXml(node, "SHIFT14HCombo4");
				Combo5Configuration = TextEditorConfiguration.FromXml(node, "SHIFT14HCombo5");

				SubHeader1Configuration = TextEditorConfiguration.FromXml(node, "SHIFT14HTAB1SHUBHEADER1");
				SubHeader2Configuration = TextEditorConfiguration.FromXml(node, "SHIFT14HTAB2SHUBHEADER1");
				SubHeader3Configuration = TextEditorConfiguration.FromXml(node, "SHIFT14HTAB3SHUBHEADER1");
				SubHeader4Configuration = TextEditorConfiguration.FromXml(node, "SHIFT14HTAB4SHUBHEADER1");
				SubHeader5Configuration = TextEditorConfiguration.FromXml(node, "SHIFT14HTAB5SHUBHEADER1");
				SubHeader6Configuration = TextEditorConfiguration.FromXml(node, "SHIFT14HTAB6SHUBHEADER1");
			}
