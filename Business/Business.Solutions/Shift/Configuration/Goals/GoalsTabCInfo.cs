...
namespace Asa.Business.Solutions.Shift.Configuration.Goals
{
	public class GoalsTabCInfo : ShiftTabWithHeaderInfo
	{
		...
		public override void LoadData(XmlNode configNode, ResourceManager resourceManager)
		{
			...
			Combo1Configuration = TextEditorConfiguration.FromXml(node, "SHIFT04CMULTIBOX1");
			Combo2Configuration = TextEditorConfiguration.FromXml(node, "SHIFT04CMULTIBOX2");
			Combo3Configuration = TextEditorConfiguration.FromXml(node, "SHIFT04CMULTIBOX3");
		}
	}
}
