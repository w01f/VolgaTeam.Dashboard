namespace NewBizWiz.AdSchedule.Controls.PresentationClasses.InputClasses
{
    partial class ScheduleSettingsControl
    {
        ...
        private void InitializeComponent()
        {
			...
			this.laPrintProductBottomBarTitle = new System.Windows.Forms.Label();
			...
			this.gridColumnDigitalProductsType = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			...
			this.gridControlPrintProducts.Size = new System.Drawing.Size(826, 336);
			...
			// 
			// gridViewPrintProducts
			// 
			this.gridViewPrintProducts.Appearance.BandPanel.Font = new System.Drawing.Font("Arial", 9.75F, System.Drawing.FontStyle.Bold);
			this.gridViewPrintProducts.Appearance.BandPanel.Options.UseFont = true;
			this.gridViewPrintProducts.Appearance.BandPanel.Options.UseTextOptions = true;
			this.gridViewPrintProducts.Appearance.BandPanel.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.gridViewPrintProducts.Appearance.HeaderPanel.Font = new System.Drawing.Font("Arial", 9.75F, System.Drawing.FontStyle.Bold);
			this.gridViewPrintProducts.Appearance.HeaderPanel.Options.UseFont = true;
			this.gridViewPrintProducts.Appearance.HeaderPanel.Options.UseTextOptions = true;
			this.gridViewPrintProducts.Appearance.HeaderPanel.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.gridViewPrintProducts.Appearance.Row.Font = new System.Drawing.Font("Arial", 9.75F);
			this.gridViewPrintProducts.Appearance.Row.Options.UseFont = true;
			this.gridViewPrintProducts.Appearance.RowSeparator.BackColor = System.Drawing.Color.AliceBlue;
			this.gridViewPrintProducts.Appearance.RowSeparator.Options.UseBackColor = true;
			this.gridViewPrintProducts.Bands.AddRange(new DevExpress.XtraGrid.Views.BandedGrid.GridBand[] {
			...
			this.gridViewPrintProducts.OptionsBehavior.AllowDeleteRows = DevExpress.Utils.DefaultBoolean.False;
			this.gridViewPrintProducts.OptionsBehavior.AutoPopulateColumns = false;
			this.gridViewPrintProducts.OptionsBehavior.AutoUpdateTotalSummary = false;
			this.gridViewPrintProducts.OptionsCustomization.AllowFilter = false;
			this.gridViewPrintProducts.OptionsCustomization.AllowGroup = false;
			this.gridViewPrintProducts.OptionsCustomization.AllowQuickHideColumns = false;
			this.gridViewPrintProducts.OptionsCustomization.AllowSort = false;
			this.gridViewPrintProducts.OptionsFilter.AllowColumnMRUFilterList = false;
			this.gridViewPrintProducts.OptionsFilter.AllowFilterEditor = false;
			this.gridViewPrintProducts.OptionsFilter.AllowMRUFilterList = false;
			this.gridViewPrintProducts.OptionsMenu.EnableColumnMenu = false;
			this.gridViewPrintProducts.OptionsMenu.EnableFooterMenu = false;
			this.gridViewPrintProducts.OptionsMenu.EnableGroupPanelMenu = false;
			this.gridViewPrintProducts.OptionsMenu.ShowDateTimeGroupIntervalItems = false;
			this.gridViewPrintProducts.OptionsMenu.ShowGroupSortSummaryItems = false;
			this.gridViewPrintProducts.OptionsSelection.EnableAppearanceHideSelection = false;
			this.gridViewPrintProducts.OptionsSelection.UseIndicatorForSelection = false;
			this.gridViewPrintProducts.OptionsView.ColumnAutoWidth = true;
			this.gridViewPrintProducts.OptionsView.ShowBands = false;
			this.gridViewPrintProducts.OptionsView.ShowDetailButtons = false;
			this.gridViewPrintProducts.OptionsView.ShowGroupExpandCollapseButtons = false;
			...
			this.laScheduleName.Size = new System.Drawing.Size(828, 30);
			...
			// 
			this.pnPrintProductBottomBar.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(175)))), ((int)(((byte)(210)))), ((int)(((byte)(255)))));
			this.pnPrintProductBottomBar.Controls.Add(this.pictureBoxPrintProductAppLogo);
			this.pnPrintProductBottomBar.Controls.Add(this.buttonXPrintProductLogo);
			this.pnPrintProductBottomBar.Controls.Add(this.buttonXPrintProductCode);
			...
			this.pnPrintProductBottomBar.Controls.Add(this.laPrintProductBottomBarTitle);
			this.pnPrintProductBottomBar.Dock = System.Windows.Forms.DockStyle.Bottom;
			this.pnPrintProductBottomBar.Location = new System.Drawing.Point(0, 336);
			...
			this.pictureBoxPrintProductAppLogo.Location = new System.Drawing.Point(676, 0);
			this.pictureBoxPrintProductAppLogo.Name = "pictureBoxPrintProductAppLogo";
			this.pictureBoxPrintProductAppLogo.Size = new System.Drawing.Size(150, 38);
			...
			this.buttonXPrintProductLogo.Location = new System.Drawing.Point(67, 5);
			...
			this.buttonXPrintProductCode.Location = new System.Drawing.Point(173, 5);
			...
			this.buttonXPrintProductDelivery.Location = new System.Drawing.Point(279, 5);
			...
			this.buttonXPrintProductReadership.Location = new System.Drawing.Point(385, 5);
			...
			// 
			// laPrintProductBottomBarTitle
			// 
			this.laPrintProductBottomBarTitle.Dock = System.Windows.Forms.DockStyle.Left;
			this.laPrintProductBottomBarTitle.Font = new System.Drawing.Font("Arial", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(204)));
			this.laPrintProductBottomBarTitle.Location = new System.Drawing.Point(0, 0);
			this.laPrintProductBottomBarTitle.Name = "laPrintProductBottomBarTitle";
			this.laPrintProductBottomBarTitle.Size = new System.Drawing.Size(61, 38);
			this.laPrintProductBottomBarTitle.TabIndex = 2;
			this.laPrintProductBottomBarTitle.Text = "Show:";
			this.laPrintProductBottomBarTitle.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			...
			this.xtraTabPageDigitalProducts.Size = new System.Drawing.Size(826, 374);
			...
			this.gridControlDigitalProducts.Size = new System.Drawing.Size(826, 336);
            ...
            this.gridColumnDigitalProductsType,
			...
			this.gridBandDigitalProductType.Width = 615;
			// 
			// gridColumnDigitalProductsType
			// 
			this.gridColumnDigitalProductsType.AppearanceCell.Font = new System.Drawing.Font("Arial", 9.75F);
			this.gridColumnDigitalProductsType.AppearanceCell.Options.UseFont = true;
			this.gridColumnDigitalProductsType.AppearanceCell.Options.UseTextOptions = true;
			this.gridColumnDigitalProductsType.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.gridColumnDigitalProductsType.Caption = "Web Category";
			this.gridColumnDigitalProductsType.ColumnEdit = this.repositoryItemComboBoxDigitalProductsType;
			this.gridColumnDigitalProductsType.FieldName = "WebCategory";
			this.gridColumnDigitalProductsType.Name = "gridColumnDigitalProductsType";
			this.gridColumnDigitalProductsType.Visible = true;
			this.gridColumnDigitalProductsType.Width = 615;
			// 
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.repositoryItemComboBoxDigitalProductsType.Items.AddRange(new object[] {
            "Display Ads",
			...
			this.repositoryItemComboBoxDigitalProductsType.NullText = "Select web category";
			...
			// 
			this.gridColumnDigitalProductsSubCategory.Caption = "SubCategory";
			...
			this.gridBandDigitalProductName.Width = 600;
			// 
			// gridColumnDigitalProductsName
			// 
			this.gridColumnDigitalProductsName.AppearanceCell.Font = new System.Drawing.Font("Arial", 12F, System.Drawing.FontStyle.Bold);
			...
			this.gridColumnDigitalProductsName.Width = 600;
			// 
			// repositoryItemComboBoxDigitalProductsNames
			// 
			this.repositoryItemComboBoxDigitalProductsNames.Appearance.Font = new System.Drawing.Font("Arial", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(204)));
			this.repositoryItemComboBoxDigitalProductsNames.Appearance.Options.UseFont = true;
			this.repositoryItemComboBoxDigitalProductsNames.AppearanceDisabled.Font = new System.Drawing.Font("Arial", 12F);
			...
			this.repositoryItemComboBoxDigitalProductsNames.AppearanceFocused.Font = new System.Drawing.Font("Arial", 12F);
			this.repositoryItemComboBoxDigitalProductsNames.AppearanceFocused.Options.UseFont = true;
			this.repositoryItemComboBoxDigitalProductsNames.AppearanceReadOnly.Font = new System.Drawing.Font("Arial", 12F);
			...
			this.gridBandDigitalProductWidth.Width = 80;
			// 
			...
			this.gridColumnDigitalProductsWidth.Width = 80;
			// 
			...
			this.gridBandDigitalProductHeight.Width = 80;
			// 
			...
			this.gridColumnDigitalProductsHeight.Width = 80;
			// 
			...
			this.gridColumnDigitalProductsRateType.FieldName = "RateTypeText";
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.repositoryItemComboBoxDigitalProductsRateType.Items.AddRange(new object[] {
            "CPM",
            "Fixed"});
			...
			this.pnDigitalProductBottomBar.Location = new System.Drawing.Point(0, 336);
			...
			this.pictureBoxDigitalProductAppLogo.Location = new System.Drawing.Point(676, 0);
			this.pictureBoxDigitalProductAppLogo.Name = "pictureBoxDigitalProductAppLogo";
			this.pictureBoxDigitalProductAppLogo.Size = new System.Drawing.Size(150, 38);
		...
		private System.Windows.Forms.Label laPrintProductBottomBarTitle;
		private DevComponents.DotNetBar.ButtonX buttonXPrintProductLogo;
		private DevComponents.DotNetBar.ButtonX buttonXPrintProductCode;
		...
		private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn gridColumnDigitalProductsType;
