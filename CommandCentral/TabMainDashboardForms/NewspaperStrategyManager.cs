...
namespace CommandCentral.TabMainDashboard
{
    class NewspaperStrategyManager
    {
        ...
        public static void UpdateData()
        {
            ...
            CommonClasses.HomeViewSettings _defaultHomeViewSettings = new CommonClasses.HomeViewSettings();

            CommonClasses.PrintScheduleViewSettings _defaultPrintScheduleViewSettings = new CommonClasses.PrintScheduleViewSettings();

            CommonClasses.PublicationBasicOverviewSettings _defaultPublicationBasicOverviewSettings = new CommonClasses.PublicationBasicOverviewSettings();
            CommonClasses.PublicationMultiSummarySettings _defaultPublicationMultiSummarySettings = new CommonClasses.PublicationMultiSummarySettings();
            CommonClasses.SnapshotViewSettings _defaultSnapshotViewSettings = new CommonClasses.SnapshotViewSettings();

            CommonClasses.GridColumnsState _defaultDetailedGridColumnState = new CommonClasses.GridColumnsState();
            CommonClasses.AdNotesState _defaultDetailedGridAdNotesState = new CommonClasses.AdNotesState();
            CommonClasses.SlideBulletsState _defaultDetailedGridSlideBulletsState = new CommonClasses.SlideBulletsState();
            CommonClasses.SlideHeaderState _defaultDetailedGridSlideHeaderState = new CommonClasses.SlideHeaderState();

            CommonClasses.GridColumnsState _defaultMultiGridColumnState = new CommonClasses.GridColumnsState();
            CommonClasses.AdNotesState _defaultMultiGridAdNotesState = new CommonClasses.AdNotesState();
            CommonClasses.SlideBulletsState _defaultMultiGridSlideBulletsState = new CommonClasses.SlideBulletsState();
            CommonClasses.SlideHeaderState _defaultMultiGridSlideHeaderState = new CommonClasses.SlideHeaderState();

            CommonClasses.CalendarViewSettings _defaultCalendarViewSettings = new CommonClasses.CalendarViewSettings();
