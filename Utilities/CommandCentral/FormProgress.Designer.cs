namespace CommandCentral
{
	partial class FormProgress
	{
		...
		private void InitializeComponent()
		{
			...
			// progressPanel
			// 
			this.progressPanel.AnimationAcceleration = 2F;
			this.progressPanel.AnimationSpeed = 8F;
			this.progressPanel.Appearance.BackColor = System.Drawing.Color.Transparent;
			this.progressPanel.Appearance.ForeColor = System.Drawing.Color.Navy;
			...
			this.progressPanel.Caption = "Processing data ...";
			this.progressPanel.Description = "Processing data ...";
			this.progressPanel.Dock = System.Windows.Forms.DockStyle.Fill;
			this.progressPanel.FrameInterval = 700;
			this.progressPanel.ImageHorzOffset = 20;
			this.progressPanel.LineAnimationElementType = DevExpress.Utils.Animation.LineAnimationElementType.Rectangle;
			...
			this.progressPanel.RingAnimationDiameter = 35;
