...
namespace Asa.Solutions.StarApp.PresentationClasses.ContentEditors
{
	public partial class ShareTabVControl : ShareTabBaseControl
	{
		...
		public override void LoadData()
		{
			...
			slidesEditContainer.LoadData(ShareContentContainer.SlideContainer.EditedContent.ShareState.TabV.Slide);
			Application.DoEvents();
		...
		{
			var slideObject = ShareContentContainer.SlideContainer.EditedContent.ShareState.TabV.Slide;
			...
			if (slideObject.SourceSlideMasters.ContainsKey(SlideSettingsManager.Instance.SlideSettings.Format))
			{
				...
				var targetSlideMaster = ShareContentContainer.SlideContainer.StarInfo.ShareConfiguration.PartVSlides.Slides
