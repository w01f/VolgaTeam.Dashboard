...
{
	[ToolboxItem(false)]
	public sealed partial class NextStepsTabEControl : ChildTabBaseControl
	{
		private NextStepsTabEInfo CustomTabInfo => (NextStepsTabEInfo)TabInfo;

		public NextStepsTabEControl(IChildTabPageContainer slideContainer, ShiftChildTabInfo tabInfo) : base(slideContainer, tabInfo)
		{
			InitializeComponent();
		...
		public override void LoadData()
		{
			...
			clipartEditContainer1.LoadData(SlideContainer.EditedContent.NextStepsState.TabE.Clipart1);
			clipartEditContainer2.LoadData(SlideContainer.EditedContent.NextStepsState.TabE.Clipart2);

			comboBoxEditSlideHeader.EditValue = SlideContainer.EditedContent.NextStepsState.TabE.SlideHeader ??
				CustomTabInfo.HeadersItems.FirstOrDefault(h => h.IsDefault);

			memoEditSubheader1.EditValue = SlideContainer.EditedContent.NextStepsState.TabE.Subheader1 ??
											CustomTabInfo.SubHeader1DefaultValue;
			memoEditSubheader2.EditValue = SlideContainer.EditedContent.NextStepsState.TabE.Subheader2 ??
											CustomTabInfo.SubHeader2DefaultValue;
			memoEditSubheader3.EditValue = SlideContainer.EditedContent.NextStepsState.TabE.Subheader3 ??
											CustomTabInfo.SubHeader3DefaultValue;
			memoEditSubheader4.EditValue = SlideContainer.EditedContent.NextStepsState.TabE.Subheader4 ??
											CustomTabInfo.SubHeader4DefaultValue;
			memoEditSubheader5.EditValue = SlideContainer.EditedContent.NextStepsState.TabE.Subheader5 ??
										   CustomTabInfo.SubHeader5DefaultValue;
			memoEditSubheader6.EditValue = SlideContainer.EditedContent.NextStepsState.TabE.Subheader6 ??
										   CustomTabInfo.SubHeader6DefaultValue;
			memoEditSubheader7.EditValue = SlideContainer.EditedContent.NextStepsState.TabE.Subheader7 ??
										   CustomTabInfo.SubHeader7DefaultValue;
			memoEditSubheader8.EditValue = SlideContainer.EditedContent.NextStepsState.TabE.Subheader8 ??
		...
		public override void ApplyChanges()
		{
			...
			SlideContainer.EditedContent.NextStepsState.TabE.Clipart1 = clipartEditContainer1.GetActiveClipartObject();
			SlideContainer.EditedContent.NextStepsState.TabE.Clipart2 = clipartEditContainer2.GetActiveClipartObject();
			...
			SlideContainer.EditedContent.NextStepsState.TabE.SlideHeader = slideHeaderValue != CustomTabInfo.HeadersItems.FirstOrDefault(h => h.IsDefault) ?
				slideHeaderValue :
				null;

			SlideContainer.EditedContent.NextStepsState.TabE.Subheader1 =
				memoEditSubheader1.EditValue as String != CustomTabInfo.SubHeader1DefaultValue
					...
					: null;
			SlideContainer.EditedContent.NextStepsState.TabE.Subheader2 =
				memoEditSubheader2.EditValue as String != CustomTabInfo.SubHeader2DefaultValue
					...
					: null;
			SlideContainer.EditedContent.NextStepsState.TabE.Subheader3 =
				memoEditSubheader3.EditValue as String != CustomTabInfo.SubHeader3DefaultValue
					...
					: null;
			SlideContainer.EditedContent.NextStepsState.TabE.Subheader4 =
				memoEditSubheader4.EditValue as String != CustomTabInfo.SubHeader4DefaultValue
					...
					: null;
			SlideContainer.EditedContent.NextStepsState.TabE.Subheader5 =
				memoEditSubheader5.EditValue as String != CustomTabInfo.SubHeader5DefaultValue
					...
					: null;
			SlideContainer.EditedContent.NextStepsState.TabE.Subheader6 =
				memoEditSubheader6.EditValue as String != CustomTabInfo.SubHeader6DefaultValue
					...
					: null;
			SlideContainer.EditedContent.NextStepsState.TabE.Subheader7 =
				memoEditSubheader7.EditValue as String != CustomTabInfo.SubHeader7DefaultValue
					...
					: null;
			SlideContainer.EditedContent.NextStepsState.TabE.Subheader8 =
		...
		{
			return SlideContainer.EditedContent.NextStepsState.TabE.EnableOutput ?? CustomTabInfo.EnableOutput;
		}

		public override void ApplyOutputEnableState(Boolean outputEnabled)
		{
			SlideContainer.EditedContent.NextStepsState.TabE.EnableOutput =
		...
		protected override OutputDataPackage GetOutputData()
		{
			...
			var clipart1 = SlideContainer.EditedContent.NextStepsState.TabE.Clipart1 ??
						  ImageClipartObject.FromImage(CustomTabInfo.Clipart1Image);
			if (clipart1 != null)
				outputDataPackage.ClipartItems.Add("SHIFT14ECLIPART1", clipart1);
			var clipart2 = SlideContainer.EditedContent.NextStepsState.TabE.Clipart2 ??
						   ImageClipartObject.FromImage(CustomTabInfo.Clipart2Image);
			if (clipart2 != null)
				outputDataPackage.ClipartItems.Add("SHIFT14ECLIPART2", clipart2);

			outputDataPackage.TemplateName =
				MasterWizardManager.Instance.SelectedWizard.GetShiftNextStepsFile("e_grow_business.pptx");

			outputDataPackage.TextItems.Add("SHIFT14EHEADER".ToUpper(), (SlideContainer.EditedContent.NextStepsState.TabE.SlideHeader ?? CustomTabInfo.HeadersItems.FirstOrDefault(h => h.IsDefault))?.Value);

			outputDataPackage.TextItems.Add("SHIFT14ESUBHEADER1".ToUpper(), SlideContainer.EditedContent.NextStepsState.TabE.Subheader1 ?? CustomTabInfo.SubHeader1DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT14ESUBHEADER2".ToUpper(), SlideContainer.EditedContent.NextStepsState.TabE.Subheader2 ?? CustomTabInfo.SubHeader2DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT14ESUBHEADER3".ToUpper(), SlideContainer.EditedContent.NextStepsState.TabE.Subheader3 ?? CustomTabInfo.SubHeader3DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT14ESUBHEADER4".ToUpper(), SlideContainer.EditedContent.NextStepsState.TabE.Subheader4 ?? CustomTabInfo.SubHeader4DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT14ESUBHEADER5".ToUpper(), SlideContainer.EditedContent.NextStepsState.TabE.Subheader5 ?? CustomTabInfo.SubHeader5DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT14ESUBHEADER6".ToUpper(), SlideContainer.EditedContent.NextStepsState.TabE.Subheader6 ?? CustomTabInfo.SubHeader6DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT14ESUBHEADER7".ToUpper(), SlideContainer.EditedContent.NextStepsState.TabE.Subheader7 ?? CustomTabInfo.SubHeader7DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT14ESUBHEADER8".ToUpper(), SlideContainer.EditedContent.NextStepsState.TabE.Subheader8 ?? CustomTabInfo.SubHeader8DefaultValue);
