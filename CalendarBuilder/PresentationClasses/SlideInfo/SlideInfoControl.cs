    ...
    public partial class SlideInfoControl : UserControl
    {
        ...
        public void LoadCurrentMonthData()
        {
            if (_month != null)
            {
                ...
                textEditBasicBusinessName.EditValue = !string.IsNullOrEmpty(_month.OutputData.BusinessName) ? _month.OutputData.BusinessName : _month.Parent.Schedule.BusinessName;

                buttonXBasicDecisionMaker.Checked = _month.OutputData.ShowDecisionMaker;
                textEditBasicDecisionMaker.EditValue = !string.IsNullOrEmpty(_month.OutputData.DecisionMaker) ? _month.OutputData.DecisionMaker : _month.Parent.Schedule.DecisionMaker;
        ...
        public void SaveData()
        {
            if (_allowToSave)
            {
                ...
                _month.OutputData.BusinessName = textEditBasicBusinessName.EditValue != null && !textEditBasicBusinessName.EditValue.ToString().Equals(_month.Parent.Schedule.BusinessName) ? textEditBasicBusinessName.EditValue.ToString() : string.Empty;

                _month.OutputData.ShowDecisionMaker = buttonXBasicDecisionMaker.Checked;
                _month.OutputData.DecisionMaker = textEditBasicDecisionMaker.EditValue != null && !textEditBasicDecisionMaker.EditValue.ToString().Equals(_month.Parent.Schedule.DecisionMaker) ? textEditBasicDecisionMaker.EditValue.ToString() : string.Empty;
        ...
        {
            buttonXCostNewspaperCalculated.Enabled = style == BusinessClasses.CalendarStyle.Advanced;
            xtraTabPageLegend.PageVisible = style == BusinessClasses.CalendarStyle.Advanced;
        }
        ...
        private void pictureEditLogo_Click(object sender, System.EventArgs e)
        {
            ...
            {
                if (form.ShowDialog() == DialogResult.OK && form.SelectedSource != null && form.SelectedSource.BigImage != null)
                {
                    pictureEditLogo.Image = new System.Drawing.Bitmap(form.SelectedSource.BigImage);
                }
            }
        }
        #endregion
