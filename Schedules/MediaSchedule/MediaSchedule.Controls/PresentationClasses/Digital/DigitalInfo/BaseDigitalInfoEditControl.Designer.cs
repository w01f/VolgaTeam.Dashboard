...
namespace Asa.Media.Controls.PresentationClasses.Digital.DigitalInfo
{
	partial class BaseDigitalInfoEditControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.gridBandMain.Columns.Add(this.bandedGridColumnId);
			this.gridBandMain.Columns.Add(this.bandedGridColumnLogo);
			this.gridBandMain.Columns.Add(this.bandedGridColumnCategory);
			this.gridBandMain.Columns.Add(this.bandedGridColumnGroup);
			this.gridBandMain.Columns.Add(this.bandedGridColumnProduct);
			this.gridBandMain.Columns.Add(this.bandedGridColumnInfo);
			this.gridBandMain.Name = "gridBandMain";
			this.gridBandMain.VisibleIndex = 0;
			this.gridBandMain.Width = 667;
			// 
			// bandedGridColumnId
			// 
			...
			this.bandedGridColumnId.AutoFillDown = true;
			...
			this.bandedGridColumnId.OptionsColumn.FixedWidth = true;
			...
			this.bandedGridColumnId.Width = 35;
			// 
			...
			this.bandedGridColumnLogo.OptionsColumn.FixedWidth = true;
			...
			// 
			this.bandedGridColumnCategory.AppearanceHeader.Options.UseTextOptions = true;
			this.bandedGridColumnCategory.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Near;
			...
			this.bandedGridColumnCategory.RowCount = 3;
			this.bandedGridColumnCategory.Visible = true;
			this.bandedGridColumnCategory.Width = 131;
			// 
			...
			this.repositoryItemComboBoxCategory.ButtonClick += new DevExpress.XtraEditors.Controls.ButtonPressedEventHandler(this.OnButtonsRepositoryItemButtonClick);
			// 
			// bandedGridColumnGroup
			// 
			this.bandedGridColumnGroup.AppearanceHeader.Options.UseTextOptions = true;
			this.bandedGridColumnGroup.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Near;
			...
			this.bandedGridColumnGroup.RowCount = 3;
			this.bandedGridColumnGroup.Visible = true;
			this.bandedGridColumnGroup.Width = 131;
			// 
			...
			// 
			this.bandedGridColumnProduct.AppearanceHeader.Options.UseTextOptions = true;
			this.bandedGridColumnProduct.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Near;
			...
			this.bandedGridColumnProduct.RowCount = 3;
			this.bandedGridColumnProduct.Visible = true;
			this.bandedGridColumnProduct.Width = 131;
			// 
			...
			this.bandedGridColumnInfo.Width = 119;
			// 
			...
			this.spinEditMonthlyInvestment.Properties.AppearanceFocused.ForeColor = System.Drawing.Color.Black;
			this.spinEditMonthlyInvestment.Properties.AppearanceFocused.Options.UseForeColor = true;
			...
			this.spinEditTotalInvestment.Properties.AppearanceFocused.ForeColor = System.Drawing.Color.Black;
			this.spinEditTotalInvestment.Properties.AppearanceFocused.Options.UseForeColor = true;
