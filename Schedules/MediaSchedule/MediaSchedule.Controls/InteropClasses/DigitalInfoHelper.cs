...
namespace Asa.Media.Controls.InteropClasses
{
	...
	{
		#region Digital
		public void AppendDigitalOneSheet(StandaloneDigitalInfoOutputModel page, Theme selectedTheme, bool pasteToSlideMaster, Presentation destinationPresentation = null)
		{
			try
			{
		...
		public void PrepareDigitalOneSheetEmail(string fileName, StandaloneDigitalInfoOutputModel page, Theme selectedTheme, bool pasteToSlideMaster)
		{
			PreparePresentation(fileName, presentation => AppendDigitalOneSheet(page, selectedTheme, pasteToSlideMaster, presentation));
		}

		public void PrepareDigitalOneSheetPdf(string targetFileName, StandaloneDigitalInfoOutputModel page, Theme selectedTheme, bool pasteToSlideMaster)
		{
			var sourceFileName = Path.GetTempFileName();
			PreparePresentation(sourceFileName, presentation => AppendDigitalOneSheet(page, selectedTheme, pasteToSlideMaster, presentation));
