...
namespace NewBizWiz.MediaSchedule.Controls.InteropClasses
{
	public partial class MediaSchedulePowerPointHelper
	{
								...
								for (int i = 1; i <= shape.Tags.Count; i++)
								{
									switch (shape.Tags.Name(i))
									{
										case "HEADER":
											...
											break;
										case "CAMPAIGN":
											if (!string.IsNullOrEmpty(summary.CampaignDates))
										...
										case "STARTENDDATE":
											...
											break;
										case "PREPAREDFOR":
											if (!string.IsNullOrEmpty(summary.Advertiser))
												shape.Visible = MsoTriState.msoTrue;
											else
												shape.Visible = MsoTriState.msoFalse;
											break;
										case "ADVERTISER":
											...
											break;
										case "LINECLIENT":
											if (!string.IsNullOrEmpty(summary.DecisionMaker))
												shape.Visible = MsoTriState.msoTrue;
											else
												shape.Visible = MsoTriState.msoFalse;
											break;
										...
										case "TOTAL2":
											...
											break;
										case "MWH":
											if (!string.IsNullOrEmpty(summary.TotalMonthlyValue))
												shape.Visible = MsoTriState.msoTrue;
											else
												shape.Visible = MsoTriState.msoFalse;
											break;
										case "TOTALMW":
											...
											break;
										case "MWT":
											if (!string.IsNullOrEmpty(summary.TotalTotalValue))
												shape.Visible = MsoTriState.msoTrue;
											else
												shape.Visible = MsoTriState.msoFalse;
											break;
		...
		public void PrepareSummaryEmail(SummaryControl summary, string fileName)
		{
