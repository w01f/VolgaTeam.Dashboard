...
{
    partial class SlideBulletsControl
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
			...
			this.checkEditColumnInches = new DevExpress.XtraEditors.CheckEdit();
			...
			this.pnSignature = new System.Windows.Forms.Panel();
			this.checkEditSignature = new DevExpress.XtraEditors.CheckEdit();
			this.superTooltip = new DevComponents.DotNetBar.SuperTooltip();
			this.pnMain.SuspendLayout();
			this.xtraScrollableControl.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.checkEditReadership.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.styleController)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.checkEditDelivery.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.checkEditTotalDiscounts.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.checkEditTotalColor.Properties)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.checkEditColumnInches.Properties)).BeginInit();
			...
			this.pnMain.Size = new System.Drawing.Size(282, 447);
			...
			this.xtraScrollableControl.Controls.Add(this.checkEditReadership);
			this.xtraScrollableControl.Controls.Add(this.checkEditDelivery);
			this.xtraScrollableControl.Controls.Add(this.checkEditTotalDiscounts);
			this.xtraScrollableControl.Controls.Add(this.checkEditTotalColor);
			...
			this.xtraScrollableControl.Controls.Add(this.checkEditColumnInches);
			...
			this.xtraScrollableControl.Controls.Add(this.checkEditTotalFinalCost);
			this.xtraScrollableControl.Controls.Add(this.checkEditTotalInserts);
			...
			this.checkEditReadership.EditValueChanging += new DevExpress.XtraEditors.Controls.ChangingEventHandler(this.checkEdit_EditValueChanging);
			// 
			// styleController
			// 
			...
			this.checkEditDelivery.EditValueChanging += new DevExpress.XtraEditors.Controls.ChangingEventHandler(this.checkEdit_EditValueChanging);
			// 
			...
			this.checkEditTotalDiscounts.EditValueChanging += new DevExpress.XtraEditors.Controls.ChangingEventHandler(this.checkEdit_EditValueChanging);
			// 
			// checkEditTotalColor
			// 
			...
			this.checkEditTotalColor.EditValueChanging += new DevExpress.XtraEditors.Controls.ChangingEventHandler(this.checkEdit_EditValueChanging);
			// 
			// checkEditAvgPCI
			// 
			...
			this.checkEditAvgPCI.EditValueChanging += new DevExpress.XtraEditors.Controls.ChangingEventHandler(this.checkEdit_EditValueChanging);
			// 
			...
			this.checkEditAvgFinalCost.EditValueChanging += new DevExpress.XtraEditors.Controls.ChangingEventHandler(this.checkEdit_EditValueChanging);
			// 
			// checkEditAvgAdCost
			// 
			...
			this.checkEditAvgAdCost.EditValueChanging += new DevExpress.XtraEditors.Controls.ChangingEventHandler(this.checkEdit_EditValueChanging);
			// 
			...
			this.checkEditTotalSquare.EditValueChanging += new DevExpress.XtraEditors.Controls.ChangingEventHandler(this.checkEdit_EditValueChanging);
			// 
			...
			this.checkEditColumnInches.EditValueChanging += new DevExpress.XtraEditors.Controls.ChangingEventHandler(this.checkEdit_EditValueChanging);
			// 
			...
			this.checkEditPercentOfPage.EditValueChanging += new DevExpress.XtraEditors.Controls.ChangingEventHandler(this.checkEdit_EditValueChanging);
			// 
			// checkEditDimensions
			// 
			...
			this.checkEditDimensions.EditValueChanging += new DevExpress.XtraEditors.Controls.ChangingEventHandler(this.checkEdit_EditValueChanging);
			// 
			// checkEditPageSize
			// 
			...
			this.checkEditPageSize.EditValueChanging += new DevExpress.XtraEditors.Controls.ChangingEventHandler(this.checkEdit_EditValueChanging);
			// 
			// checkEditTotalFinalCost
			// 
			...
			this.checkEditTotalFinalCost.EditValueChanging += new DevExpress.XtraEditors.Controls.ChangingEventHandler(this.checkEdit_EditValueChanging);
			// 
			// checkEditTotalInserts
			// 
			this.checkEditTotalInserts.Dock = System.Windows.Forms.DockStyle.Top;
			...
			this.checkEditTotalInserts.EditValueChanging += new DevExpress.XtraEditors.Controls.ChangingEventHandler(this.checkEdit_EditValueChanging);
			// 
			// pnSlideOptions
			// 
			...
			// checkEditAllSlides
			// 
			this.checkEditAllSlides.Location = new System.Drawing.Point(112, 39);
			...
			// checkEditLastSlide
			// 
			this.checkEditLastSlide.Location = new System.Drawing.Point(0, 39);
			this.checkEditLastSlide.Name = "checkEditLastSlide";
			...
			// 
			this.checkEditEnableSlideBullets.EditValue = true;
			this.checkEditEnableSlideBullets.Location = new System.Drawing.Point(0, 7);
			...
			this.pnSignature.Size = new System.Drawing.Size(282, 34);
			this.pnSignature.TabIndex = 53;
			// 
			// checkEditSignature
			// 
			this.checkEditSignature.EditValue = true;
			this.checkEditSignature.Location = new System.Drawing.Point(0, 6);
			this.checkEditSignature.Name = "checkEditSignature";
			this.checkEditSignature.Properties.Appearance.Font = new System.Drawing.Font("Arial", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(204)));
			...
			((System.ComponentModel.ISupportInitialize)(this.checkEditReadership.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.styleController)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.checkEditDelivery.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.checkEditTotalDiscounts.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.checkEditTotalColor.Properties)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.checkEditColumnInches.Properties)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.checkEditTotalFinalCost.Properties)).EndInit();
			...
			this.pnSignature.PerformLayout();
			((System.ComponentModel.ISupportInitialize)(this.checkEditSignature.Properties)).EndInit();
        ...
        public DevExpress.XtraEditors.CheckEdit checkEditDelivery;
        public DevExpress.XtraEditors.CheckEdit checkEditPageSize;
        public DevExpress.XtraEditors.CheckEdit checkEditTotalFinalCost;
        ...
        public DevExpress.XtraEditors.CheckEdit checkEditColumnInches;
        public DevExpress.XtraEditors.CheckEdit checkEditTotalSquare;
        public DevExpress.XtraEditors.CheckEdit checkEditTotalColor;
        public DevExpress.XtraEditors.CheckEdit checkEditTotalInserts;
        private System.Windows.Forms.Panel pnSlideOptions;
