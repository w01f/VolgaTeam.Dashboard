...
namespace Asa.Solutions.Shift.PresentationClasses.ContentEditors.Goals
{
	...
	public sealed partial class GoalsTabAControl : ChildTabBaseControl
	{
		...
		public override void LoadData()
		{
			...
			memoPopupEdit1.LoadData(SlideContainer.EditedContent.GoalsState.TabA.Combo1);
			memoPopupEdit2.LoadData(SlideContainer.EditedContent.GoalsState.TabA.Combo2);
			memoPopupEdit3.LoadData(SlideContainer.EditedContent.GoalsState.TabA.Combo3);
		...
		public override void ApplyChanges()
		{
			...
			SlideContainer.EditedContent.GoalsState.TabA.Combo1 = memoPopupEdit1.GetSelectedItem();
			SlideContainer.EditedContent.GoalsState.TabA.Combo2 = memoPopupEdit2.GetSelectedItem();
			SlideContainer.EditedContent.GoalsState.TabA.Combo3 = memoPopupEdit3.GetSelectedItem();
		...
		protected override OutputDataPackage GetOutputData()
		{
			...
			var combos = new[]
				{
					(SlideContainer.EditedContent.GoalsState.TabA.Combo1??CustomTabInfo.Combo1DefaultItem)?.Value,
					(SlideContainer.EditedContent.GoalsState.TabA.Combo2 ?? CustomTabInfo.Combo2DefaultItem)?.Value,
					(SlideContainer.EditedContent.GoalsState.TabA.Combo3 ?? CustomTabInfo.Combo3DefaultItem)?.Value,
				}
