...
namespace Asa.Solutions.StarApp.PresentationClasses.ContentEditors.Solution
{
	...
	public sealed partial class SolutionTabCControl : ChildTabBaseControl
	{
		...
		{
			return SlideContainer.EditedContent.SolutionState.TabC.EnableOutput ?? CustomTabInfo.EnableOutput;
		}
		...
		{
			SlideContainer.EditedContent.SolutionState.TabC.EnableOutput =
