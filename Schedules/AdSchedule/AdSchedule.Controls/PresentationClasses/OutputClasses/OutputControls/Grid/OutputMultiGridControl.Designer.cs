...
{
    partial class OutputMultiGridControl
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
			...
			this.gridViewPublications.RowHeight = 50;
			...
			this.gridColumnID.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.True;
			...
			this.gridColumnPCIRate.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			this.gridColumnPCIRate.OptionsColumn.FixedWidth = true;
			this.gridColumnPCIRate.Visible = true;
			this.gridColumnPCIRate.VisibleIndex = 3;
			...
			this.gridColumnADRate.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.True;
			this.gridColumnADRate.OptionsColumn.FixedWidth = true;
			this.gridColumnADRate.Visible = true;
			this.gridColumnADRate.VisibleIndex = 4;
			...
			this.gridColumnDiscountRate.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			this.gridColumnDiscountRate.OptionsColumn.FixedWidth = true;
			this.gridColumnDiscountRate.Visible = true;
			this.gridColumnDiscountRate.VisibleIndex = 5;
			...
			this.gridColumnColorPricing.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			this.gridColumnColorPricing.OptionsColumn.FixedWidth = true;
			this.gridColumnColorPricing.Visible = true;
			this.gridColumnColorPricing.VisibleIndex = 6;
			...
			this.gridColumnFinalRate.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.True;
			this.gridColumnFinalRate.OptionsColumn.FixedWidth = true;
			this.gridColumnFinalRate.Visible = true;
			this.gridColumnFinalRate.VisibleIndex = 7;
			...
			this.gridColumnIndex.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			this.gridColumnIndex.OptionsColumn.FixedWidth = true;
			this.gridColumnIndex.Visible = true;
			this.gridColumnIndex.VisibleIndex = 8;
			...
			this.gridColumnImage.AppearanceHeader.Options.UseTextOptions = true;
			this.gridColumnImage.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.gridColumnImage.ColumnEdit = this.repositoryItemPictureEdit;
			this.gridColumnImage.FieldName = "MultiGridLogo";
			this.gridColumnImage.Fixed = DevExpress.XtraGrid.Columns.FixedStyle.Left;
			...
			this.gridColumnImage.Width = 120;
			// 
			// repositoryItemPictureEdit
			// 
			this.repositoryItemPictureEdit.CustomHeight = 40;
