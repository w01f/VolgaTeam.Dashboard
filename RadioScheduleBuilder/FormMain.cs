...
using RadioScheduleBuilder.ConfigurationClasses;
using RadioScheduleBuilder.CustomControls;
	...
	public partial class FormMain : Form
	{
		...
		private void FormMain_Shown(object sender, EventArgs e)
		{
			...
			if (!string.IsNullOrEmpty(SettingsManager.Instance.SelectedWizard))
				Instance.Text = "Radio Schedule Builder - " + SettingsManager.Instance.SelectedWizard + " - " + SettingsManager.Instance.Size;
