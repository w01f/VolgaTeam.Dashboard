...
namespace CommandCentral.TabMainDashboard
{
    class TVStrategyManager
    {
        ...
        private static List<CommonClasses.TVProgram> _programs = new List<CommonClasses.TVProgram>();
                ...
                foreach (var daypart in _dayparts)
                {
                    ...
                    try
                    {
                        ...
                        if (dataTable.Rows.Count > 0 && dataTable.Columns.Count >= 4)
                            foreach (DataRow row in dataTable.Rows)
                            {
                                CommonClasses.TVProgram program = new CommonClasses.TVProgram();
