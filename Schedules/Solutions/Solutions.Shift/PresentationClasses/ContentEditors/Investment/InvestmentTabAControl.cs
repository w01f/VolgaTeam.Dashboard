...
{
	[ToolboxItem(false)]
	public sealed partial class InvestmentTabAControl : ChildTabBaseControl
	{
		private InvestmentTabAInfo CustomTabInfo => (InvestmentTabAInfo)TabInfo;

		public InvestmentTabAControl(IChildTabPageContainer slideContainer, ShiftChildTabInfo tabInfo) : base(slideContainer, tabInfo)
		{
			InitializeComponent();
		...
		public override void LoadData()
		{
			...
			clipartEditContainer1.LoadData(SlideContainer.EditedContent.InvestmentState.TabA.Clipart1);
			clipartEditContainer2.LoadData(SlideContainer.EditedContent.InvestmentState.TabA.Clipart2);
			clipartEditContainer3.LoadData(SlideContainer.EditedContent.InvestmentState.TabA.Clipart3);
			clipartEditContainer4.LoadData(SlideContainer.EditedContent.InvestmentState.TabA.Clipart4);
			clipartEditContainer5.LoadData(SlideContainer.EditedContent.InvestmentState.TabA.Clipart5);

			comboBoxEditSlideHeader.EditValue = SlideContainer.EditedContent.InvestmentState.TabA.SlideHeader ??
				CustomTabInfo.HeadersItems.FirstOrDefault(h => h.IsDefault);
			comboBoxEditCombo1.EditValue = SlideContainer.EditedContent.InvestmentState.TabA.Combo1 ??
										   CustomTabInfo.Combo1Items.FirstOrDefault(item => item.IsDefault);
			comboBoxEditCombo2.EditValue = SlideContainer.EditedContent.InvestmentState.TabA.Combo2 ??
										   CustomTabInfo.Combo2Items.FirstOrDefault(item => item.IsDefault);
			comboBoxEditCombo3.EditValue = SlideContainer.EditedContent.InvestmentState.TabA.Combo3 ??
										   CustomTabInfo.Combo3Items.FirstOrDefault(item => item.IsDefault);
			comboBoxEditCombo4.EditValue = SlideContainer.EditedContent.InvestmentState.TabA.Combo4 ??
										   CustomTabInfo.Combo4Items.FirstOrDefault(item => item.IsDefault);
			comboBoxEditCombo5.EditValue = SlideContainer.EditedContent.InvestmentState.TabA.Combo5 ??
										   CustomTabInfo.Combo5Items.FirstOrDefault(item => item.IsDefault);
			comboBoxEditCombo6.EditValue = SlideContainer.EditedContent.InvestmentState.TabA.Combo6 ??
										   CustomTabInfo.Combo6Items.FirstOrDefault(item => item.IsDefault);

			textEditSubheader1.EditValue = SlideContainer.EditedContent.InvestmentState.TabA.Subheader1 ??
										   CustomTabInfo.SubHeader1DefaultValue;
			memoEditSubheader2.EditValue = SlideContainer.EditedContent.InvestmentState.TabA.Subheader2 ??
		...
		public override void ApplyChanges()
		{
			...
			SlideContainer.EditedContent.InvestmentState.TabA.Clipart1 = clipartEditContainer1.GetActiveClipartObject();
			SlideContainer.EditedContent.InvestmentState.TabA.Clipart2 = clipartEditContainer2.GetActiveClipartObject();
			SlideContainer.EditedContent.InvestmentState.TabA.Clipart3 = clipartEditContainer3.GetActiveClipartObject();
			SlideContainer.EditedContent.InvestmentState.TabA.Clipart4 = clipartEditContainer4.GetActiveClipartObject();
			SlideContainer.EditedContent.InvestmentState.TabA.Clipart5 = clipartEditContainer5.GetActiveClipartObject();
			...
			SlideContainer.EditedContent.InvestmentState.TabA.SlideHeader = slideHeaderValue != CustomTabInfo.HeadersItems.FirstOrDefault(h => h.IsDefault) ?
				slideHeaderValue :
				null;

			SlideContainer.EditedContent.InvestmentState.TabA.Combo1 = CustomTabInfo.Combo1Items.FirstOrDefault(h => h.IsDefault) != comboBoxEditCombo1.EditValue ?
				comboBoxEditCombo1.EditValue as ListDataItem ?? new ListDataItem { Value = comboBoxEditCombo1.EditValue as String } :
				null;
			SlideContainer.EditedContent.InvestmentState.TabA.Combo2 = CustomTabInfo.Combo2Items.FirstOrDefault(h => h.IsDefault) != comboBoxEditCombo2.EditValue ?
				comboBoxEditCombo2.EditValue as ListDataItem ?? new ListDataItem { Value = comboBoxEditCombo2.EditValue as String } :
				null;
			SlideContainer.EditedContent.InvestmentState.TabA.Combo3 = CustomTabInfo.Combo3Items.FirstOrDefault(h => h.IsDefault) != comboBoxEditCombo3.EditValue ?
				comboBoxEditCombo3.EditValue as ListDataItem ?? new ListDataItem { Value = comboBoxEditCombo3.EditValue as String } :
				null;
			SlideContainer.EditedContent.InvestmentState.TabA.Combo4 = CustomTabInfo.Combo4Items.FirstOrDefault(h => h.IsDefault) != comboBoxEditCombo4.EditValue ?
				comboBoxEditCombo4.EditValue as ListDataItem ?? new ListDataItem { Value = comboBoxEditCombo4.EditValue as String } :
				null;
			SlideContainer.EditedContent.InvestmentState.TabA.Combo5 = CustomTabInfo.Combo5Items.FirstOrDefault(h => h.IsDefault) != comboBoxEditCombo5.EditValue ?
				comboBoxEditCombo5.EditValue as ListDataItem ?? new ListDataItem { Value = comboBoxEditCombo5.EditValue as String } :
				null;
			SlideContainer.EditedContent.InvestmentState.TabA.Combo6 = CustomTabInfo.Combo6Items.FirstOrDefault(h => h.IsDefault) != comboBoxEditCombo6.EditValue ?
				comboBoxEditCombo6.EditValue as ListDataItem ?? new ListDataItem { Value = comboBoxEditCombo6.EditValue as String } :
				null;

			SlideContainer.EditedContent.InvestmentState.TabA.Subheader1 =
				textEditSubheader1.EditValue as String != CustomTabInfo.SubHeader1DefaultValue
					...
					: null;
			SlideContainer.EditedContent.InvestmentState.TabA.Subheader2 =
		...
		{
			return SlideContainer.EditedContent.InvestmentState.TabA.EnableOutput ?? CustomTabInfo.EnableOutput;
		}

		public override void ApplyOutputEnableState(Boolean outputEnabled)
		{
			SlideContainer.EditedContent.InvestmentState.TabA.EnableOutput =
		...
		protected override OutputDataPackage GetOutputData()
		{
			...
			var clipart1 = SlideContainer.EditedContent.InvestmentState.TabA.Clipart1 ??
						  ImageClipartObject.FromImage(CustomTabInfo.Clipart1Image);
			if (clipart1 != null)
				outputDataPackage.ClipartItems.Add("SHIFT12ACLIPART1", clipart1);
			var clipart2 = SlideContainer.EditedContent.InvestmentState.TabA.Clipart2 ??
						   ImageClipartObject.FromImage(CustomTabInfo.Clipart2Image);
			if (clipart2 != null)
				outputDataPackage.ClipartItems.Add("SHIFT12ACLIPART2", clipart2);
			var clipart3 = SlideContainer.EditedContent.InvestmentState.TabA.Clipart3 ??
						   ImageClipartObject.FromImage(CustomTabInfo.Clipart3Image);
			if (clipart3 != null)
				outputDataPackage.ClipartItems.Add("SHIFT12ACLIPART3", clipart3);
			var clipart4 = SlideContainer.EditedContent.InvestmentState.TabA.Clipart4 ??
						   ImageClipartObject.FromImage(CustomTabInfo.Clipart4Image);
			if (clipart4 != null)
				outputDataPackage.ClipartItems.Add("SHIFT12ACLIPART4", clipart4);
			var clipart5 = SlideContainer.EditedContent.InvestmentState.TabA.Clipart5 ??
						   ImageClipartObject.FromImage(CustomTabInfo.Clipart5Image);
			if (clipart5 != null)
				outputDataPackage.ClipartItems.Add("SHIFT12ACLIPART5", clipart5);

			outputDataPackage.TemplateName =
				MasterWizardManager.Instance.SelectedWizard.GetShiftInvestmentFile("investment_a.pptx");

			outputDataPackage.TextItems.Add("SHIFT12AHEADER".ToUpper(), (SlideContainer.EditedContent.InvestmentState.TabA.SlideHeader ?? CustomTabInfo.HeadersItems.FirstOrDefault(h => h.IsDefault))?.Value);

			outputDataPackage.TextItems.Add("SHIFT12ACOMBO1".ToUpper(), (SlideContainer.EditedContent.InvestmentState.TabA.Combo1 ?? CustomTabInfo.Combo1Items.FirstOrDefault(h => h.IsDefault))?.Value);
			outputDataPackage.TextItems.Add("SHIFT12ACOMBO2".ToUpper(), (SlideContainer.EditedContent.InvestmentState.TabA.Combo2 ?? CustomTabInfo.Combo2Items.FirstOrDefault(h => h.IsDefault))?.Value);
			outputDataPackage.TextItems.Add("SHIFT12ACOMBO3".ToUpper(), (SlideContainer.EditedContent.InvestmentState.TabA.Combo3 ?? CustomTabInfo.Combo3Items.FirstOrDefault(h => h.IsDefault))?.Value);
			outputDataPackage.TextItems.Add("SHIFT12ACOMBO4".ToUpper(), (SlideContainer.EditedContent.InvestmentState.TabA.Combo4 ?? CustomTabInfo.Combo4Items.FirstOrDefault(h => h.IsDefault))?.Value);
			outputDataPackage.TextItems.Add("SHIFT12ACOMBO5".ToUpper(), (SlideContainer.EditedContent.InvestmentState.TabA.Combo5 ?? CustomTabInfo.Combo5Items.FirstOrDefault(h => h.IsDefault))?.Value);
			outputDataPackage.TextItems.Add("SHIFT12ACOMBO6".ToUpper(), (SlideContainer.EditedContent.InvestmentState.TabA.Combo6 ?? CustomTabInfo.Combo6Items.FirstOrDefault(h => h.IsDefault))?.Value);

			outputDataPackage.TextItems.Add("SHIFT12ASUBHEADER1".ToUpper(), SlideContainer.EditedContent.InvestmentState.TabA.Subheader1 ?? CustomTabInfo.SubHeader1DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT12ASUBHEADER2".ToUpper(), SlideContainer.EditedContent.InvestmentState.TabA.Subheader2 ?? CustomTabInfo.SubHeader2DefaultValue);
