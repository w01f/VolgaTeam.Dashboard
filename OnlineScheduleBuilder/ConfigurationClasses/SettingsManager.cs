...
namespace OnlineScheduleBuilder.ConfigurationClasses
{
    class SettingsManager
    {
        ...
        private SettingsManager()
        {
            ...
            this.HelpLinksPath = string.Format(@"{0}\newlocaldirect.com\app\HelpUrls\OnlineHelp.xml", System.Environment.GetFolderPath(System.Environment.SpecialFolder.ProgramFiles));
            this.SuccessModelsPath = string.Format(@"{0}\newlocaldirect.com\app\models\OnlineScheduleBuilder", System.Environment.GetFolderPath(System.Environment.SpecialFolder.ProgramFiles));
            this.InventoryImagePath = string.Format(@"{0}\newlocaldirect.com\app\online_ribbon_logo.png", System.Environment.GetFolderPath(System.Environment.SpecialFolder.ProgramFiles));

            LoadAppID();
            CheckSaveFolder();
            LoadSharedSettings();

            _defaultSaveFolderPath = Path.Combine(string.Format(@"{0}\newlocaldirect.com\sync\Outgoing", System.Environment.GetFolderPath(System.Environment.SpecialFolder.ProgramFiles)), "AppID-" + this.AppID.ToString(), @"Saved_Schedules\Online Schedule Builder");
