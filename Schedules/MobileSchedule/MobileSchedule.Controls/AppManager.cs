...
namespace MobileScheduleBuilder
{
    public class AppManager
    {
        ...
        private static void RemoveInstances()
        {
            ...
            CustomControls.MobilePackageControl.RemoveInstance();
        ...
        {
            MessageBox.Show(text, "Mobile Schedule Builder", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        }

        public static DialogResult ShowWarningQuestion(string text)
        {
            return MessageBox.Show(text, "Mobile Schedule Builder", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);
        }

        public static void ShowInformation(string text)
        {
            MessageBox.Show(text, "Mobile Schedule Builder", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
