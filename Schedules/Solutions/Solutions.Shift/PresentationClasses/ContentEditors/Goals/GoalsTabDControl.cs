...
namespace Asa.Solutions.Shift.PresentationClasses.ContentEditors.Goals
{
	...
	public sealed partial class GoalsTabDControl : ChildTabBaseControl
	{
		...
		public override void LoadData()
		{
			...
			memoPopupEdit1.LoadData(SlideContainer.EditedContent.GoalsState.TabD.MemoPopup1);
			memoPopupEdit2.LoadData(SlideContainer.EditedContent.GoalsState.TabD.MemoPopup2);
			memoPopupEdit3.LoadData(SlideContainer.EditedContent.GoalsState.TabD.MemoPopup3);
		...
		public override void ApplyChanges()
		{
			...
			SlideContainer.EditedContent.GoalsState.TabD.MemoPopup1 = memoPopupEdit1.GetSelectedItem();
			SlideContainer.EditedContent.GoalsState.TabD.MemoPopup2 = memoPopupEdit2.GetSelectedItem();
			SlideContainer.EditedContent.GoalsState.TabD.MemoPopup3 = memoPopupEdit3.GetSelectedItem();
		...
		protected override OutputDataPackage GetOutputData()
		{
			...
			var combos = new[]
				{
					(SlideContainer.EditedContent.GoalsState.TabD.MemoPopup1??CustomTabInfo.MemoPopup1DefaultItem)?.Value,
					(SlideContainer.EditedContent.GoalsState.TabD.MemoPopup2 ?? CustomTabInfo.MemoPopup2DefaultItem)?.Value,
					(SlideContainer.EditedContent.GoalsState.TabD.MemoPopup3 ?? CustomTabInfo.MemoPopup3DefaultItem)?.Value,
				}
