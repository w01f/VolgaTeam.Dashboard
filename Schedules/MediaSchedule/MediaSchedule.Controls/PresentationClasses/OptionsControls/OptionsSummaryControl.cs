...
namespace Asa.Media.Controls.PresentationClasses.OptionsControls
{
	...
	public sealed partial class OptionsSummaryControl : XtraTabPage, IOptionsSlideControl
	{
		...
		public string TemplateFilePath
		{
			get
			{
				return BusinessObjects.Instance.OutputManager.GetOptionsSummaryFile(MediaMetaData.Instance.SettingsManager.SelectedColor, GetColumnInfo().Count());
			}
		}
