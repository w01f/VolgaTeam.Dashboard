...
namespace Asa.Solutions.Shift.PresentationClasses.ContentEditors.NeedsSolutions.TabB
{
	public partial class ItemControl : UserControl
	{
		private bool _allowHandleEvents;
		private readonly List<NeedsItemInfo> _itemInfoList = new List<NeedsItemInfo>();
		private NeedsItemInfo _defaultItem;
		...
		public void Init(
			IList<NeedsItemInfo> itemInfoList,
			NeedsItemInfo defaultItem,
		...
		private void OnComboEditValueChanged(object sender, EventArgs e)
		{
			...
			var itemInfo = comboBoxEditCombo.EditValue as NeedsItemInfo;
