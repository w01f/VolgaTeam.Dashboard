...
namespace NewBizWiz.Dashboard
{
    partial class FormMain
    {
        ...
        private void InitializeComponent()
        {
			...
			this.ribbonBarCalendarBuilder.Size = new System.Drawing.Size(100, 99);
			...
			this.ribbonTabItemNewspaper.Text = "SellerPoint";
			...
			this.ribbonTabItemTV.Text = "SellerPoint";
			...
			this.ribbonTabItemRadio.Text = "SellerPoint";
			...
			this.ribbonTabItemOnline.Text = "WebSlides";
