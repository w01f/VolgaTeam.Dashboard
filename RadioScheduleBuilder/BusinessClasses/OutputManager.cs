...
namespace RadioScheduleBuilder.BusinessClasses
{
    class OutputManager
    {
        ...
        private const string OneSheetsExcelBasedTemplatesFolderName = @"{0}\Radio Slides\onesheets";
        private const string OneSheetsTableBasedTemplatesFolderName = @"{0}\Radio Slides\tables";
        private const string OneSheetsTagsBasedTemplatesFolderName = @"{0}\Radio Slides\tags";
        public const string OneSheetsExcelTemplatesFolderName = @"{0}\newlocaldirect.com\sync\Incoming\Slides\ExcelOutput{1}\Radio Slides\{2} Programs\{3}";
        public const string OneSheetTableBasedTemplateFileName = @"{0} Programs\{0}-{1}.ppt";
        public const string OneSheetExcelBasedTemplateFileName = @"radioslide1.ppt";
        ...
        public string Item3Title
        {
            get
            {
                if (!string.IsNullOrEmpty(this.TotalCost) && !string.IsNullOrEmpty(this.TotalGRP) && !string.IsNullOrEmpty(this.TotalSpot))
                    return "Total$";
                else if (!string.IsNullOrEmpty(this.TotalCPP) && (!string.IsNullOrEmpty(this.TotalSpot) | !string.IsNullOrEmpty(this.TotalGRP)) && ((!string.IsNullOrEmpty(this.TotalCost) & !string.IsNullOrEmpty(this.TotalSpot)) | !string.IsNullOrEmpty(this.TotalCost)))
                    return this.CPPHeaderTitle;
                else
                    return string.Empty;
            }
    ...
    public class OutputProgramTagsBased
    {
        ...
        public string Item3Value
        {
            get
            {
                ...
                else if (!string.IsNullOrEmpty(this.CPP) && (!string.IsNullOrEmpty(this.TotalSpots) | !string.IsNullOrEmpty(this.GRP)) && ((!string.IsNullOrEmpty(this.TotalRate) & !string.IsNullOrEmpty(this.TotalSpots)) | !string.IsNullOrEmpty(this.TotalRate)))
                    return this.CPP;
                else
                    return string.Empty;
            }
