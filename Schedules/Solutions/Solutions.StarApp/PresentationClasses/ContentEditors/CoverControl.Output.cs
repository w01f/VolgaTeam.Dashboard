...
namespace Asa.Solutions.StarApp.PresentationClasses.ContentEditors
{
	partial class CoverControl
	{
		...
		{
			public override String OutputName => OutputControl.SlideContainer.StarInfo.Titles.Tab1SubUTitle;
			...
			public TabUOutputProcessor(CoverControl outputControl) : base(outputControl) { }
			...
			{
				var slideObject = OutputControl.SlideContainer.EditedContent.CoverState.TabU.Slide;
				...
				if (slideObject.SourceSlideMasters.ContainsKey(SlideSettingsManager.Instance.SlideSettings.Format))
				{
					...
					var targetSlideMaster = OutputControl.SlideContainer.StarInfo.CoverConfiguration.PartUSlides.Slides
		...
		{
			public override String OutputName => OutputControl.SlideContainer.StarInfo.Titles.Tab1SubVTitle;
			...
			public TabVOutputProcessor(CoverControl outputControl) : base(outputControl) { }
			...
			public override OutputItem GetOutputItem()
			{
				var slideObject = OutputControl.SlideContainer.EditedContent.CoverState.TabV.Slide;

				if (slideObject.SourceSlideMasters.ContainsKey(SlideSettingsManager.Instance.SlideSettings.Format))
				{
					var slideMasterName = slideObject.SourceSlideMasters[SlideSettingsManager.Instance.SlideSettings.Format];
					var targetSlideMaster = OutputControl.SlideContainer.StarInfo.CoverConfiguration.PartVSlides.Slides
						.FirstOrDefault(slideMaster =>
							String.Equals(slideMaster.Name, slideMasterName, StringComparison.OrdinalIgnoreCase));
		...
		{
			public override String OutputName => OutputControl.SlideContainer.StarInfo.Titles.Tab1SubWTitle;
			...
			public TabWOutputProcessor(CoverControl outputControl) : base(outputControl) { }
			...
			public override OutputItem GetOutputItem()
			{
				var slideObject = OutputControl.SlideContainer.EditedContent.CoverState.TabW.Slide;

				if (slideObject.SourceSlideMasters.ContainsKey(SlideSettingsManager.Instance.SlideSettings.Format))
				{
					var slideMasterName = slideObject.SourceSlideMasters[SlideSettingsManager.Instance.SlideSettings.Format];
					var targetSlideMaster = OutputControl.SlideContainer.StarInfo.CoverConfiguration.PartWSlides.Slides
						.FirstOrDefault(slideMaster =>
							String.Equals(slideMaster.Name, slideMasterName, StringComparison.OrdinalIgnoreCase));
