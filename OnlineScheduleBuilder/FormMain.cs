...
namespace OnlineScheduleBuilder
{
    public partial class FormMain : Form
    {
        ...
        private FormMain()
        {
            ...
            #region WebPackage Events
            buttonItemWebPackageSave.Click += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageSave_Click);
            buttonItemWebPackageSaveAs.Click += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageSaveAs_Click);
            buttonItemWebPackageTitle.CheckedChanged += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageTogledButton_CheckedChanged);
            buttonItemWebPackageActiveDays.CheckedChanged += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageTogledButton_CheckedChanged);
            buttonItemWebPackageAdRate.CheckedChanged += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageTogledButton_CheckedChanged);
            buttonItemWebPackageAvgMonthlyRate.CheckedChanged += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageTogledButton_CheckedChanged);
            buttonItemWebPackageAvgTotalRate.CheckedChanged += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageTogledButton_CheckedChanged);
            buttonItemWebPackageDecisionMaker.CheckedChanged += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageTogledButton_CheckedChanged);
            buttonItemWebPackageBusinessName.CheckedChanged += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageTogledButton_CheckedChanged);
            buttonItemWebPackageCPM.CheckedChanged += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageTogledButton_CheckedChanged);
            buttonItemWebPackageDescription.CheckedChanged += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageTogledButton_CheckedChanged);
            buttonItemWebPackageDimensions.CheckedChanged += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageTogledButton_CheckedChanged);
            buttonItemWebPackageFlightDates.CheckedChanged += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageTogledButton_CheckedChanged);
            buttonItemWebPackagePresentationDate.CheckedChanged += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageTogledButton_CheckedChanged);
            buttonItemWebPackageComments.CheckedChanged += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageTogledButton_CheckedChanged);
            buttonItemWebPackageTotalAds.CheckedChanged += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageTogledButton_CheckedChanged);
            buttonItemWebPackageTotalMonthlyRate.CheckedChanged += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageTogledButton_CheckedChanged);
            buttonItemWebPackageTotalRate.CheckedChanged += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageTogledButton_CheckedChanged);
            buttonItemWebPackageWebsites.CheckedChanged += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageTogledButton_CheckedChanged);
            buttonItemWebPackageImageIcons.CheckedChanged += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageTogledButton_CheckedChanged);
            buttonItemWebPackageSignatureLine.CheckedChanged += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageTogledButton_CheckedChanged);
            buttonItemWebPackageScreenshotViewer.CheckedChanged += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageTogledButton_CheckedChanged);
            buttonItemWebPackagePowerPoint.Click += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackagePowerPoint_Click);
            buttonItemWebPackageEmail.Click += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageEmail_Click);
            buttonItemWebPackageHelp.Click += new EventHandler(CustomControls.WebPackageControl.Instance.buttonItemWebPackageHelp_Click);
            #endregion
            ...
            if ((base.CreateGraphics()).DpiX > 96)
            {
                ...
                ribbonBarWebPackageBasicInformation.RecalcLayout();
                ribbonBarWebPackageCampaignDetails.RecalcLayout();
                ...
                ribbonBarWebPackageTitle.RecalcLayout();
        ...
        public void UpdateSimpleOutputTabPageState(bool enable)
        {
            ...
            ribbonTabItemWebPackage.Enabled = enable;
        }
        ...
        public void LoadCategories()
        {
            ...
            if (BusinessClasses.ListManager.Instance.Categories.Count > 5)
            {
                ...
                superTooltip.SetSuperTooltip(categoryListButton, new DevComponents.DotNetBar.SuperTooltipInfo("Web Sales Inventory", "", "Select the Web Sales Products you want to sell", null, null, DevComponents.DotNetBar.eTooltipColor.Gray));
        ...
        private bool AllowToLeaveCurrentControl()
        {
            ...
            else if ((_currentControl == CustomControls.WebPackageControl.Instance))
            {
                if (CustomControls.WebPackageControl.Instance.AllowToLeaveControl)
                    result = true;
                else
                {
                    ribbonControl.SelectedRibbonTabChanged -= new EventHandler(ribbonControl_SelectedRibbonTabChanged);
        ...
        private void FormMain_Shown(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(ConfigurationClasses.SettingsManager.Instance.SelectedWizard))
                FormMain.Instance.Text = "Online Schedule Builder - " + ConfigurationClasses.SettingsManager.Instance.SelectedWizard + " - " + ConfigurationClasses.SettingsManager.Instance.Size;
            ...
            using (ToolForms.FormProgress form = new ToolForms.FormProgress())
            {
                ...
                System.Threading.Thread thread = new System.Threading.Thread(new System.Threading.ThreadStart(delegate()
                {
                    this.Invoke((MethodInvoker)delegate
                    {
                        ...
                        CustomControls.WebPackageControl.Instance.LoadSchedule(false);
        ...
        public void ribbonControl_SelectedRibbonTabChanged(object sender, EventArgs e)
        {
            ...
            else if (ribbonControl.SelectedRibbonTabItem == ribbonTabItemWebPackage)
            {
                if (AllowToLeaveCurrentControl())
                {
                    _currentControl = CustomControls.WebPackageControl.Instance;
                    if (!pnMain.Controls.Contains(_currentControl))
                        pnMain.Controls.Add(CustomControls.WebPackageControl.Instance);
                }
                _currentControl.BringToFront();
            }
        ...
        private void FormMain_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (_currentControl == CustomControls.ScheduleSettingsControl.Instance)
                ...
                result = CustomControls.WebPackageControl.Instance.AllowToLeaveControl;
            else if (_currentControl == CustomControls.ProductSummaryControl.Instance)
