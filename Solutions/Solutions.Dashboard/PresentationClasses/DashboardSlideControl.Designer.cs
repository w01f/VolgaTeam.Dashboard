namespace Asa.Solutions.Dashboard.PresentationClasses
{
	public partial class DashboardSlideControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.checkEditSolutionNew.Location = new System.Drawing.Point(626, 25);
			...
			this.buttonXLeadoff.Image = global::Asa.Solutions.Dashboard.Properties.Resources.SlideLeadoff;
			...
			this.buttonXLeadoff.Click += new System.EventHandler(this.OnSelectSlideType);
			// 
			// buttonXCover
			// 
			...
			this.buttonXCover.Image = global::Asa.Solutions.Dashboard.Properties.Resources.SlideCover;
			...
			this.buttonXCover.Click += new System.EventHandler(this.OnSelectSlideType);
			// 
			// buttonXClientGoals
			// 
			...
			this.buttonXClientGoals.Image = global::Asa.Solutions.Dashboard.Properties.Resources.SlideClientGoals;
			...
			this.buttonXClientGoals.Click += new System.EventHandler(this.OnSelectSlideType);
			// 
			...
			this.buttonXTargetCustomers.Image = global::Asa.Solutions.Dashboard.Properties.Resources.SlideTargetCustomers;
			...
			this.buttonXTargetCustomers.Click += new System.EventHandler(this.OnSelectSlideType);
			// 
			// buttonXSummary
			// 
			...
			this.buttonXSummary.Image = global::Asa.Solutions.Dashboard.Properties.Resources.SlideSummary;
			...
			this.buttonXSummary.Click += new System.EventHandler(this.OnSelectSlideType);
			// 
			// superTooltip
			// 
