namespace Asa.Common.GUI.Themes
{
	partial class FormThemeSelector
	{
		...
		private void InitializeComponent()
		{
			...
			this.layoutControl.Controls.Add(this.checkEditApplyThemeForAllSlideTypes);
			...
			this.layoutControlItemApplyThemeForAllSlideTypes.TextSize = new System.Drawing.Size(0, 0);
			this.layoutControlItemApplyThemeForAllSlideTypes.TextVisible = false;
			this.layoutControlItemApplyThemeForAllSlideTypes.TrimClientAreaToControl = false;
			// 
			...
			this.simpleLabelItemSlideSize.Location = new System.Drawing.Point(0, 0);
			this.simpleLabelItemSlideSize.Name = "simpleLabelItemSlideSize";
			this.simpleLabelItemSlideSize.Size = new System.Drawing.Size(315, 25);
			this.simpleLabelItemSlideSize.Text = "<b><size=+4>Slide Size: {0}</size></b>";
			this.simpleLabelItemSlideSize.TextSize = new System.Drawing.Size(122, 21);
			// 
			// simpleLabelItemThemName
			// 
			this.simpleLabelItemThemName.AllowHotTrack = false;
			this.simpleLabelItemThemName.AllowHtmlStringInCaption = true;
			this.simpleLabelItemThemName.AppearanceItemCaption.Options.UseTextOptions = true;
			this.simpleLabelItemThemName.AppearanceItemCaption.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far;
			this.simpleLabelItemThemName.Location = new System.Drawing.Point(315, 0);
			this.simpleLabelItemThemName.Name = "simpleLabelItemThemName";
			this.simpleLabelItemThemName.Size = new System.Drawing.Size(559, 25);
			this.simpleLabelItemThemName.Text = "<b><size=+4>Theme Name</size></b>";
			this.simpleLabelItemThemName.TextSize = new System.Drawing.Size(122, 21);
			// 
			// emptySpaceItem1
			// 
		...
		private DevExpress.XtraLayout.LayoutControlItem layoutControlItemApplyThemeForAllSlideTypes;
