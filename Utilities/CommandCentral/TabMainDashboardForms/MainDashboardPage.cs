...
namespace CommandCentral.TabMainDashboard
{
    ...
    {
        private static MainDashboardPage _instance = null;
        ...
        private void UncheckButtons()
        {
            ...
            FormMain.Instance.buttonItemMobileStrategy.Checked = false;
        ...
        public void UpdatePageAccordingToggledButton()
        {
            ...
            else if (FormMain.Instance.buttonItemMobileStrategy != null && FormMain.Instance.buttonItemMobileStrategy.Checked)
            {
                laTitle.Visible = true;
                DataControl.Instance.ViewSource = MobileStrategyManager.ViewSourceFile;
                DataControl.Instance.ButtonText = MobileStrategyManager.ButtonText;
                _viewFile = MobileStrategyManager.ViewDataFile;
                _updateData = MobileStrategyManager.UpdateData;
                pnMain.Controls.Add(DataControl.Instance);
            }
