...
namespace Asa.Solutions.Shift.PresentationClasses.ContentEditors.NextSteps
{
	...
	public sealed partial class NextStepsTabBControl : ChildTabBaseControl
	{
		...
		public override void LoadData()
		{
			...
			memoEditSubheader3.EditValue = SlideContainer.EditedContent.NextStepsState.TabB.Subheader3 ??
											CustomTabInfo.SubHeader3DefaultValue;
			textEditSubheader4.EditValue = SlideContainer.EditedContent.NextStepsState.TabB.Subheader4 ??
		...
		public override void ApplyChanges()
		{
			...
			SlideContainer.EditedContent.NextStepsState.TabB.Subheader2 =
				memoEditSubheader2.EditValue as String != CustomTabInfo.SubHeader2DefaultValue
					...
					: null;
			SlideContainer.EditedContent.NextStepsState.TabB.Subheader3 =
		...
		protected override OutputDataPackage GetOutputData()
		{
			...
			outputDataPackage.TextItems.Add("SHIFT14BSUBHEADER3".ToUpper(), SlideContainer.EditedContent.NextStepsState.TabB.Subheader3 ?? CustomTabInfo.SubHeader3DefaultValue);
