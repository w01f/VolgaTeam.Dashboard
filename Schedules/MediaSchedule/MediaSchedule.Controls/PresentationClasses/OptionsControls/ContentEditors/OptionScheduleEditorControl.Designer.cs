...
{
	sealed partial class OptionScheduleEditorControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.layoutControlProgramSource.TabIndex = 66;
			...
			this.gridControl.Location = new System.Drawing.Point(80, 0);
			...
			this.gridControl.Size = new System.Drawing.Size(750, 699);
			...
			this.gridBandOtherColumns.Columns.Add(this.bandedGridColumnStation);
			this.gridBandOtherColumns.Columns.Add(this.bandedGridColumnName);
			this.gridBandOtherColumns.Columns.Add(this.bandedGridColumnDay);
			this.gridBandOtherColumns.Columns.Add(this.bandedGridColumnTime);
			this.gridBandOtherColumns.Columns.Add(this.bandedGridColumnSpots);
			this.gridBandOtherColumns.Columns.Add(this.bandedGridColumnRate);
			this.gridBandOtherColumns.Columns.Add(this.bandedGridColumnLength);
			...
			this.gridBandOtherColumns.Width = 100;
			// 
			...
			this.bandedGridColumnStation.RowCount = 2;
			...
			this.bandedGridColumnName.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Near;
			this.bandedGridColumnName.AppearanceHeader.Options.UseTextOptions = true;
			this.bandedGridColumnName.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Near;
			...
			this.bandedGridColumnName.RowCount = 2;
			...
			this.repositoryItemPopupContainerEditProgram.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Near;
			this.repositoryItemPopupContainerEditProgram.AppearanceDisabled.Options.UseTextOptions = true;
			this.repositoryItemPopupContainerEditProgram.AppearanceDisabled.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Near;
			...
			this.repositoryItemPopupContainerEditProgram.AppearanceFocused.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Near;
			this.repositoryItemPopupContainerEditProgram.AppearanceReadOnly.Options.UseTextOptions = true;
			this.repositoryItemPopupContainerEditProgram.AppearanceReadOnly.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Near;
			...
			this.bandedGridColumnDay.RowCount = 2;
			...
			this.repositoryItemComboBoxDays.AppearanceDropDown.Options.UseTextOptions = true;
			this.repositoryItemComboBoxDays.AppearanceDropDown.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			...
			this.bandedGridColumnTime.RowCount = 2;
			...
			// 
			this.bandedGridColumnSpots.AppearanceCell.Font = new System.Drawing.Font("Arial", 14.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(204)));
			this.bandedGridColumnSpots.AppearanceCell.Options.HighPriority = true;
			this.bandedGridColumnSpots.AppearanceCell.Options.UseFont = true;
			...
			this.bandedGridColumnSpots.Caption = "Spots";
			...
			this.bandedGridColumnSpots.RowCount = 2;
			...
			this.bandedGridColumnRate.RowCount = 2;
			...
			this.bandedGridColumnLength.RowCount = 2;
			...
			this.bandedGridColumnCost.FieldName = "Cost";
			...
			this.bandedGridColumnCost.RowCount = 2;
			...
			this.pictureEditDefaultLogo.EditValue = global::Asa.Media.Controls.Properties.Resources.OptionsNoPrograms;
			...
			this.pictureEditDefaultLogo.Size = new System.Drawing.Size(20, 659);
			...
			this.layoutControlItemDefaultLogo.Size = new System.Drawing.Size(80, 699);
			...
			this.layoutControlItemPrograms.Location = new System.Drawing.Point(80, 0);
			...
			this.layoutControlItemPrograms.Size = new System.Drawing.Size(750, 699);
