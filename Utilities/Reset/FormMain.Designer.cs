namespace Asa.Reset
{
	partial class FormMain
	{
		...
		private void InitializeComponent()
		{
			...
			this.pbLogo.Image = global::Asa.Reset.Properties.Resources.Reset;
			...
			this.laDescription.Text = "Your adSALESapps files and settings will be removed from this device.";
			// 
			// laTitle
			// 
			...
			this.laTitle.Text = "RESET your adSALESapps?";
			// 
			// buttonXCancel
			// 
			...
			this.buttonXCancel.Click += new System.EventHandler(this.OnCancelClick);
			// 
			// FormMain
			// 
