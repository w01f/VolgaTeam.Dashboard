...
{
	public partial class ContentsItemControl : BaseTabCSubControl
	{
		...
		public override void LoadData()
		{
			...
			comboBoxEditSlideHeader.EditValue = SlideContainer.EditedContent.NeedsSolutionsState.TabC.SlideHeader ??
				Container.CustomTabInfo.HeadersItems.FirstOrDefault(h => h.IsDefault);

			comboBoxEditCombo1.EditValue = SlideContainer.EditedContent.NeedsSolutionsState.TabC.Combo1 ??
				Container.CustomTabInfo.Combo1Items.FirstOrDefault(item => item.IsDefault);

			itemSelectorControl.LoadSavedState(SlideContainer.EditedContent.NeedsSolutionsState.TabC.Items);
		...
		public override void ApplyChanges()
		{
			...
			SlideContainer.EditedContent.NeedsSolutionsState.TabC.SlideHeader = slideHeaderValue != Container.CustomTabInfo.HeadersItems.FirstOrDefault(h => h.IsDefault) ?
				slideHeaderValue :
				null;

			SlideContainer.EditedContent.NeedsSolutionsState.TabC.Combo1 = Container.CustomTabInfo.Combo1Items.FirstOrDefault(h => h.IsDefault) != comboBoxEditCombo1.EditValue ?
