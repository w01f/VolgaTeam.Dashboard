...
{
	public class NextStepsTabFInfo : ShiftTabWithHeaderInfo
	{
		public Image Clipart1Image => _resourceManager.GraphicResources?.Tab14_F_Clipart1;
		public ClipartConfiguration Clipart1Configuration { get; private set; }
		public Image Clipart2Image => _resourceManager.GraphicResources?.Tab14_F_Clipart2;
		public ClipartConfiguration Clipart2Configuration { get; private set; }
		public Image Clipart3Image => _resourceManager.GraphicResources?.Tab14_F_Clipart3;
		...
		public NextStepsTabFInfo() : base(ShiftChildTabType.F, ShiftTopTabType.NextSteps)
		{
		...
		public override void LoadData(XmlNode configNode, ResourceManager resourceManager)
		{
			...
			if (resourceManager.DataNextStepsPartFFile.ExistsLocal())
			{
				var document = new XmlDocument();
				document.Load(resourceManager.DataNextStepsPartFFile.LocalPath);

				var node = document.SelectSingleNode(@"/SHIFT14F");
				if (node == null) return;
				...
				Clipart1Configuration = ClipartConfiguration.FromXml(node, "SHIFT14FClipart1");
				Clipart2Configuration = ClipartConfiguration.FromXml(node, "SHIFT14FClipart2");
				Clipart3Configuration = ClipartConfiguration.FromXml(node, "SHIFT14FClipart3");

				CommonEditorConfiguration = TextEditorConfiguration.FromXml(node);
				HeadersEditorConfiguration = TextEditorConfiguration.FromXml(node, "SHIFT14FHeader");

				Combo1Configuration = TextEditorConfiguration.FromXml(node, "SHIFT14FCombo1");
				Combo2Configuration = TextEditorConfiguration.FromXml(node, "SHIFT14FCombo2");
				Combo3Configuration = TextEditorConfiguration.FromXml(node, "SHIFT14FCombo3");
				Combo4Configuration = TextEditorConfiguration.FromXml(node, "SHIFT14FCombo4");
				Combo5Configuration = TextEditorConfiguration.FromXml(node, "SHIFT14FCombo5");

				SubHeader1Configuration = TextEditorConfiguration.FromXml(node, "SHIFT14FTAB1SHUBHEADER1");
				SubHeader2Configuration = TextEditorConfiguration.FromXml(node, "SHIFT14FTAB2SHUBHEADER1");
				SubHeader3Configuration = TextEditorConfiguration.FromXml(node, "SHIFT14FTAB3SHUBHEADER1");
				SubHeader4Configuration = TextEditorConfiguration.FromXml(node, "SHIFT14FTAB4SHUBHEADER1");
				SubHeader5Configuration = TextEditorConfiguration.FromXml(node, "SHIFT14FTAB5SHUBHEADER1");
				SubHeader6Configuration = TextEditorConfiguration.FromXml(node, "SHIFT14FTAB6SHUBHEADER1");
			}
