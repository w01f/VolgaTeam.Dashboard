...
{
	[ToolboxItem(false)]
	public sealed partial class PartnershipTabCControl : ChildTabBaseControl
	{
		private PartnershipTabCInfo CustomTabInfo => (PartnershipTabCInfo)TabInfo;

		public PartnershipTabCControl(IChildTabPageContainer slideContainer, ShiftChildTabInfo tabInfo) : base(slideContainer, tabInfo)
		{
			InitializeComponent();
		...
		public override void LoadData()
		{
			...
			clipartEditContainer1.LoadData(SlideContainer.EditedContent.PartnershipState.TabC.Clipart1);
			clipartEditContainer2.LoadData(SlideContainer.EditedContent.PartnershipState.TabC.Clipart2);

			comboBoxEditSlideHeader.EditValue = SlideContainer.EditedContent.PartnershipState.TabC.SlideHeader ??
				CustomTabInfo.HeadersItems.FirstOrDefault(h => h.IsDefault);

			memoEditSubheader1.EditValue = SlideContainer.EditedContent.PartnershipState.TabC.Subheader1 ??
											CustomTabInfo.SubHeader1DefaultValue;
			memoEditSubheader2.EditValue = SlideContainer.EditedContent.PartnershipState.TabC.Subheader2 ??
											CustomTabInfo.SubHeader2DefaultValue;
			memoEditSubheader3.EditValue = SlideContainer.EditedContent.PartnershipState.TabC.Subheader3 ??
											CustomTabInfo.SubHeader3DefaultValue;
			memoEditSubheader4.EditValue = SlideContainer.EditedContent.PartnershipState.TabC.Subheader4 ??
											CustomTabInfo.SubHeader4DefaultValue;
			memoEditSubheader5.EditValue = SlideContainer.EditedContent.PartnershipState.TabC.Subheader5 ??
										   CustomTabInfo.SubHeader5DefaultValue;
			memoEditSubheader6.EditValue = SlideContainer.EditedContent.PartnershipState.TabC.Subheader6 ??
										   CustomTabInfo.SubHeader6DefaultValue;
			memoEditSubheader7.EditValue = SlideContainer.EditedContent.PartnershipState.TabC.Subheader7 ??
										   CustomTabInfo.SubHeader7DefaultValue;
			memoEditSubheader8.EditValue = SlideContainer.EditedContent.PartnershipState.TabC.Subheader8 ??
		...
		public override void ApplyChanges()
		{
			...
			SlideContainer.EditedContent.PartnershipState.TabC.Clipart1 = clipartEditContainer1.GetActiveClipartObject();
			SlideContainer.EditedContent.PartnershipState.TabC.Clipart2 = clipartEditContainer2.GetActiveClipartObject();
			...
			SlideContainer.EditedContent.PartnershipState.TabC.SlideHeader = slideHeaderValue != CustomTabInfo.HeadersItems.FirstOrDefault(h => h.IsDefault) ?
				slideHeaderValue :
				null;

			SlideContainer.EditedContent.PartnershipState.TabC.Subheader1 =
				memoEditSubheader1.EditValue as String != CustomTabInfo.SubHeader1DefaultValue
					...
					: null;
			SlideContainer.EditedContent.PartnershipState.TabC.Subheader2 =
				memoEditSubheader2.EditValue as String != CustomTabInfo.SubHeader2DefaultValue
					...
					: null;
			SlideContainer.EditedContent.PartnershipState.TabC.Subheader3 =
				memoEditSubheader3.EditValue as String != CustomTabInfo.SubHeader3DefaultValue
					...
					: null;
			SlideContainer.EditedContent.PartnershipState.TabC.Subheader4 =
				memoEditSubheader4.EditValue as String != CustomTabInfo.SubHeader4DefaultValue
					...
					: null;
			SlideContainer.EditedContent.PartnershipState.TabC.Subheader5 =
				memoEditSubheader5.EditValue as String != CustomTabInfo.SubHeader5DefaultValue
					...
					: null;
			SlideContainer.EditedContent.PartnershipState.TabC.Subheader6 =
				memoEditSubheader6.EditValue as String != CustomTabInfo.SubHeader6DefaultValue
					...
					: null;
			SlideContainer.EditedContent.PartnershipState.TabC.Subheader7 =
				memoEditSubheader7.EditValue as String != CustomTabInfo.SubHeader7DefaultValue
					...
					: null;
			SlideContainer.EditedContent.PartnershipState.TabC.Subheader8 =
		...
		{
			return SlideContainer.EditedContent.PartnershipState.TabC.EnableOutput ?? CustomTabInfo.EnableOutput;
		}

		public override void ApplyOutputEnableState(Boolean outputEnabled)
		{
			SlideContainer.EditedContent.PartnershipState.TabC.EnableOutput =
		...
		#region Output
		public override SlideType SlideType => SlideType.ShiftPartnershipC;
		...
		protected override OutputDataPackage GetOutputData()
		{
			...
			var clipart1 = SlideContainer.EditedContent.PartnershipState.TabC.Clipart1 ??
						  ImageClipartObject.FromImage(CustomTabInfo.Clipart1Image);
			if (clipart1 != null)
				outputDataPackage.ClipartItems.Add("SHIFT06CCLIPART1", clipart1);
			var clipart2 = SlideContainer.EditedContent.PartnershipState.TabC.Clipart2 ??
						   ImageClipartObject.FromImage(CustomTabInfo.Clipart2Image);
			if (clipart2 != null)
				outputDataPackage.ClipartItems.Add("SHIFT06CCLIPART2", clipart2);

			outputDataPackage.TemplateName =
				MasterWizardManager.Instance.SelectedWizard.GetShiftPartnershipFile("024_grow_business_c.pptx");

			outputDataPackage.TextItems.Add("SHIFT06CHEADER".ToUpper(), (SlideContainer.EditedContent.PartnershipState.TabC.SlideHeader ?? CustomTabInfo.HeadersItems.FirstOrDefault(h => h.IsDefault))?.Value);

			outputDataPackage.TextItems.Add("SHIFT06CSUBHEADER1".ToUpper(), SlideContainer.EditedContent.PartnershipState.TabC.Subheader1 ?? CustomTabInfo.SubHeader1DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT06CSUBHEADER2".ToUpper(), SlideContainer.EditedContent.PartnershipState.TabC.Subheader2 ?? CustomTabInfo.SubHeader2DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT06CSUBHEADER3".ToUpper(), SlideContainer.EditedContent.PartnershipState.TabC.Subheader3 ?? CustomTabInfo.SubHeader3DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT06CSUBHEADER4".ToUpper(), SlideContainer.EditedContent.PartnershipState.TabC.Subheader4 ?? CustomTabInfo.SubHeader4DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT06CSUBHEADER5".ToUpper(), SlideContainer.EditedContent.PartnershipState.TabC.Subheader5 ?? CustomTabInfo.SubHeader5DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT06CSUBHEADER6".ToUpper(), SlideContainer.EditedContent.PartnershipState.TabC.Subheader6 ?? CustomTabInfo.SubHeader6DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT06CSUBHEADER7".ToUpper(), SlideContainer.EditedContent.PartnershipState.TabC.Subheader7 ?? CustomTabInfo.SubHeader7DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT06CSUBHEADER8".ToUpper(), SlideContainer.EditedContent.PartnershipState.TabC.Subheader8 ?? CustomTabInfo.SubHeader8DefaultValue);
