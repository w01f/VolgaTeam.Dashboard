...
namespace TVScheduleBuilder
{
    public class AppManager
    {
        ...
        {
            MessageBox.Show(text, "TV Schedule Builder", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        }

        public static DialogResult ShowWarningQuestion(string text)
        {
            return MessageBox.Show(text, "TV Schedule Builder", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);
        }

        public static void ShowInformation(string text)
        {
            MessageBox.Show(text, "TV Schedule Builder", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
