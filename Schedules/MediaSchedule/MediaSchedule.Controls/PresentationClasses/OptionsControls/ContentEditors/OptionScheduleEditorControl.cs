...
namespace Asa.Media.Controls.PresentationClasses.OptionsControls.ContentEditors
{
        ...
        IOptionsSlideData
    {
        ...
        public void InitControls()
        {
            ...
            PopupStateHelper.Init(repositoryItemPopupContainerEditProgram, Common.Core.Configuration.ResourceManager.Instance.AppSettingsFolder, "OptionSection");
        }
        ...
        public IList<OutputItem> GetOutputItems()
        {
            ...
            if (_data.Programs.Any() && (_data.ShowLineId || _data.ShowStation || _data.ShowProgram || _data.ShowDay || _data.ShowTime || _data.ShowSpots || _data.ShowRate || _data.ShowLenght || _data.ShowCost))
            {
                outputItems.Add(new OutputItem
                {
                    ...
                    Enabled = BusinessObjects.Instance.OutputManager.OptionsOutputConfiguration.EnablePrograms,
                ...
                if (_data.DigitalInfo.Records.Any())
                    outputItems.Add(new OutputItem
                    {
                        ...
                        Enabled = BusinessObjects.Instance.OutputManager.OptionsOutputConfiguration.EnableProgramsDigital,
                        IsCurrent = false,
                        PresentationSourcePath = Path.Combine(Common.Core.Configuration.ResourceManager.Instance.TempFolder.LocalPath,
                        Path.GetFileName(Path.GetTempFileName())),
