...
{
	[ToolboxItem(false)]
	public sealed partial class PartnershipTabDControl : ChildTabBaseControl
	{
		private PartnershipTabDInfo CustomTabInfo => (PartnershipTabDInfo)TabInfo;

		public PartnershipTabDControl(IChildTabPageContainer slideContainer, ShiftChildTabInfo tabInfo) : base(slideContainer, tabInfo)
		{
			InitializeComponent();
		...
		public override void LoadData()
		{
			...
			clipartEditContainer1.LoadData(SlideContainer.EditedContent.PartnershipState.TabD.Clipart1);
			clipartEditContainer2.LoadData(SlideContainer.EditedContent.PartnershipState.TabD.Clipart2);

			comboBoxEditSlideHeader.EditValue = SlideContainer.EditedContent.PartnershipState.TabD.SlideHeader ??
				CustomTabInfo.HeadersItems.FirstOrDefault(h => h.IsDefault);

			memoEditSubheader1.EditValue = SlideContainer.EditedContent.PartnershipState.TabD.Subheader1 ??
											CustomTabInfo.SubHeader1DefaultValue;
			memoEditSubheader2.EditValue = SlideContainer.EditedContent.PartnershipState.TabD.Subheader2 ??
											CustomTabInfo.SubHeader2DefaultValue;
			memoEditSubheader3.EditValue = SlideContainer.EditedContent.PartnershipState.TabD.Subheader3 ??
											CustomTabInfo.SubHeader3DefaultValue;
			memoEditSubheader4.EditValue = SlideContainer.EditedContent.PartnershipState.TabD.Subheader4 ??
											CustomTabInfo.SubHeader4DefaultValue;
			memoEditSubheader5.EditValue = SlideContainer.EditedContent.PartnershipState.TabD.Subheader5 ??
										   CustomTabInfo.SubHeader5DefaultValue;
			memoEditSubheader6.EditValue = SlideContainer.EditedContent.PartnershipState.TabD.Subheader6 ??
										   CustomTabInfo.SubHeader6DefaultValue;
			memoEditSubheader7.EditValue = SlideContainer.EditedContent.PartnershipState.TabD.Subheader7 ??
										   CustomTabInfo.SubHeader7DefaultValue;
			memoEditSubheader8.EditValue = SlideContainer.EditedContent.PartnershipState.TabD.Subheader8 ??
		...
		public override void ApplyChanges()
		{
			...
			SlideContainer.EditedContent.PartnershipState.TabD.Clipart1 = clipartEditContainer1.GetActiveClipartObject();
			SlideContainer.EditedContent.PartnershipState.TabD.Clipart2 = clipartEditContainer2.GetActiveClipartObject();
			...
			SlideContainer.EditedContent.PartnershipState.TabD.SlideHeader = slideHeaderValue != CustomTabInfo.HeadersItems.FirstOrDefault(h => h.IsDefault) ?
				slideHeaderValue :
				null;

			SlideContainer.EditedContent.PartnershipState.TabD.Subheader1 =
				memoEditSubheader1.EditValue as String != CustomTabInfo.SubHeader1DefaultValue
					...
					: null;
			SlideContainer.EditedContent.PartnershipState.TabD.Subheader2 =
				memoEditSubheader2.EditValue as String != CustomTabInfo.SubHeader2DefaultValue
					...
					: null;
			SlideContainer.EditedContent.PartnershipState.TabD.Subheader3 =
				memoEditSubheader3.EditValue as String != CustomTabInfo.SubHeader3DefaultValue
					...
					: null;
			SlideContainer.EditedContent.PartnershipState.TabD.Subheader4 =
				memoEditSubheader4.EditValue as String != CustomTabInfo.SubHeader4DefaultValue
					...
					: null;
			SlideContainer.EditedContent.PartnershipState.TabD.Subheader5 =
				memoEditSubheader5.EditValue as String != CustomTabInfo.SubHeader5DefaultValue
					...
					: null;
			SlideContainer.EditedContent.PartnershipState.TabD.Subheader6 =
				memoEditSubheader6.EditValue as String != CustomTabInfo.SubHeader6DefaultValue
					...
					: null;
			SlideContainer.EditedContent.PartnershipState.TabD.Subheader7 =
				memoEditSubheader7.EditValue as String != CustomTabInfo.SubHeader7DefaultValue
					...
					: null;
			SlideContainer.EditedContent.PartnershipState.TabD.Subheader8 =
		...
		{
			return SlideContainer.EditedContent.PartnershipState.TabD.EnableOutput ?? CustomTabInfo.EnableOutput;
		}

		public override void ApplyOutputEnableState(Boolean outputEnabled)
		{
			SlideContainer.EditedContent.PartnershipState.TabD.EnableOutput =
		...
		#region Output
		public override SlideType SlideType => SlideType.ShiftPartnershipD;
		...
		protected override OutputDataPackage GetOutputData()
		{
			...
			var clipart1 = SlideContainer.EditedContent.PartnershipState.TabD.Clipart1 ??
						  ImageClipartObject.FromImage(CustomTabInfo.Clipart1Image);
			if (clipart1 != null)
				outputDataPackage.ClipartItems.Add("SHIFT06DCLIPART1", clipart1);
			var clipart2 = SlideContainer.EditedContent.PartnershipState.TabD.Clipart2 ??
						   ImageClipartObject.FromImage(CustomTabInfo.Clipart2Image);
			if (clipart2 != null)
				outputDataPackage.ClipartItems.Add("SHIFT06DCLIPART2", clipart2);

			outputDataPackage.TemplateName =
				MasterWizardManager.Instance.SelectedWizard.GetShiftPartnershipFile("025_grow_business_d.pptx");

			outputDataPackage.TextItems.Add("SHIFT06DHEADER".ToUpper(), (SlideContainer.EditedContent.PartnershipState.TabD.SlideHeader ?? CustomTabInfo.HeadersItems.FirstOrDefault(h => h.IsDefault))?.Value);

			outputDataPackage.TextItems.Add("SHIFT06DSUBHEADER1".ToUpper(), SlideContainer.EditedContent.PartnershipState.TabD.Subheader1 ?? CustomTabInfo.SubHeader1DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT06DSUBHEADER2".ToUpper(), SlideContainer.EditedContent.PartnershipState.TabD.Subheader2 ?? CustomTabInfo.SubHeader2DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT06DSUBHEADER3".ToUpper(), SlideContainer.EditedContent.PartnershipState.TabD.Subheader3 ?? CustomTabInfo.SubHeader3DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT06DSUBHEADER4".ToUpper(), SlideContainer.EditedContent.PartnershipState.TabD.Subheader4 ?? CustomTabInfo.SubHeader4DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT06DSUBHEADER5".ToUpper(), SlideContainer.EditedContent.PartnershipState.TabD.Subheader5 ?? CustomTabInfo.SubHeader5DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT06DSUBHEADER6".ToUpper(), SlideContainer.EditedContent.PartnershipState.TabD.Subheader6 ?? CustomTabInfo.SubHeader6DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT06DSUBHEADER7".ToUpper(), SlideContainer.EditedContent.PartnershipState.TabD.Subheader7 ?? CustomTabInfo.SubHeader7DefaultValue);
			outputDataPackage.TextItems.Add("SHIFT06DSUBHEADER8".ToUpper(), SlideContainer.EditedContent.PartnershipState.TabD.Subheader8 ?? CustomTabInfo.SubHeader8DefaultValue);
