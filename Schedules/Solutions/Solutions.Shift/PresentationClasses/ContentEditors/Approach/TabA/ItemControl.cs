...
namespace Asa.Solutions.Shift.PresentationClasses.ContentEditors.Approach.TabA
{
	...
	public partial class ItemControl : BaseTabASubControl
	{
		...
		public ItemControl(ApproachItemInfo itemInfo, ApproachTabAControl container) : base(container)
		{
			InitializeComponent();
		...
		public override void ApplyChanges()
		{
			...
			if (savedState == null)
			{
				savedState = new ApproachState.ApproachItemState();
				savedState.Id = ItemInfo.Id;
				SlideContainer.EditedContent.ApproachState.TabA.Items.Add(savedState);
			}
