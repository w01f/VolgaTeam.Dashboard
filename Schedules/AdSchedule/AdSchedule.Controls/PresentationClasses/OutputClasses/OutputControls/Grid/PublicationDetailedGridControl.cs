...
namespace NewBizWiz.AdSchedule.Controls.PresentationClasses.OutputClasses.OutputControls
{
	...
	//public partial class PublicationDetailedGridControl : System.Windows.Forms.UserControl
	{
		...
		private void gridViewPublications_CalcPreviewText(object sender, CalcPreviewTextEventArgs e)
		{
			...
			if (Controller.Instance.Grids.DetailedGrid.ShowSectionInPreview && !string.IsNullOrEmpty(gridViewPublications.GetRowCellValue(e.RowHandle, gridColumnSection).ToString()))
				previewText.Add(Controller.Instance.Grids.DetailedGrid.PositionSectionInPreview > 0 && !previewText.Keys.Contains(Controller.Instance.Grids.DetailedGrid.PositionSectionInPreview) ? Controller.Instance.Grids.DetailedGrid.PositionSectionInPreview : ++maxNumber, "Section: " + gridViewPublications.GetRowCellValue(e.RowHandle, gridColumnSection));
			if (Controller.Instance.Grids.DetailedGrid.ShowMechanicalsInPreview && !string.IsNullOrEmpty((string)gridViewPublications.GetRowCellValue(e.RowHandle, gridColumnMechanicals)))
				previewText.Add(Controller.Instance.Grids.DetailedGrid.PositionMechanicalsInPreview > 0 && !previewText.Keys.Contains(Controller.Instance.Grids.DetailedGrid.PositionMechanicalsInPreview) ? Controller.Instance.Grids.DetailedGrid.PositionMechanicalsInPreview : ++maxNumber, "Mech: " + gridViewPublications.GetRowCellValue(e.RowHandle, gridColumnMechanicals));
			if (Controller.Instance.Grids.DetailedGrid.ShowDeliveryInPreview && !string.IsNullOrEmpty(gridViewPublications.GetRowCellValue(e.RowHandle, gridColumnDelivery).ToString()))
				previewText.Add(Controller.Instance.Grids.DetailedGrid.PositionDeliveryInPreview > 0 && !previewText.Keys.Contains(Controller.Instance.Grids.DetailedGrid.PositionDeliveryInPreview) ? Controller.Instance.Grids.DetailedGrid.PositionDeliveryInPreview : ++maxNumber, "Delivery: " + gridViewPublications.GetRowCellValue(e.RowHandle, gridColumnDelivery));
			if (Controller.Instance.Grids.DetailedGrid.ShowPublicationInPreview && !string.IsNullOrEmpty(gridViewPublications.GetRowCellValue(e.RowHandle, gridColumnPublication).ToString()))
				previewText.Add(Controller.Instance.Grids.DetailedGrid.PositionPublicationInPreview > 0 && !previewText.Keys.Contains(Controller.Instance.Grids.DetailedGrid.PositionPublicationInPreview) ? Controller.Instance.Grids.DetailedGrid.PositionPublicationInPreview : ++maxNumber, "Publication: " + gridViewPublications.GetRowCellValue(e.RowHandle, gridColumnPublication));
			if (Controller.Instance.Grids.DetailedGrid.ShowPageSizeInPreview && !string.IsNullOrEmpty((string)gridViewPublications.GetRowCellValue(e.RowHandle, gridColumnPageSize)))
				previewText.Add(Controller.Instance.Grids.DetailedGrid.PositionPageSizeInPreview > 0 && !previewText.Keys.Contains(Controller.Instance.Grids.DetailedGrid.PositionPageSizeInPreview) ? Controller.Instance.Grids.DetailedGrid.PositionPageSizeInPreview : ++maxNumber, "Page Size: " + gridViewPublications.GetRowCellValue(e.RowHandle, gridColumnPageSize));
			if (Controller.Instance.Grids.DetailedGrid.ShowPercentOfPageInPreview && !string.IsNullOrEmpty((string)gridViewPublications.GetRowCellValue(e.RowHandle, gridColumnPercentOfPage)))
				previewText.Add(Controller.Instance.Grids.DetailedGrid.PositionPercentOfPageInPreview > 0 && !previewText.Keys.Contains(Controller.Instance.Grids.DetailedGrid.PositionPercentOfPageInPreview) ? Controller.Instance.Grids.DetailedGrid.PositionPercentOfPageInPreview : ++maxNumber, "% of Page: " + gridViewPublications.GetRowCellValue(e.RowHandle, gridColumnPercentOfPage));
			if (Controller.Instance.Grids.DetailedGrid.ShowDimensionsInPreview && !string.IsNullOrEmpty(gridViewPublications.GetRowCellValue(e.RowHandle, gridColumnDimensions).ToString()))
				previewText.Add(Controller.Instance.Grids.DetailedGrid.PositionDimensionsInPreview > 0 && !previewText.Keys.Contains(Controller.Instance.Grids.DetailedGrid.PositionDimensionsInPreview) ? Controller.Instance.Grids.DetailedGrid.PositionDimensionsInPreview : ++maxNumber, "Col. x Inches: " + gridViewPublications.GetRowCellValue(e.RowHandle, gridColumnDimensions));
			if (Controller.Instance.Grids.DetailedGrid.ShowColumnInchesInPreview && !string.IsNullOrEmpty(gridViewPublications.GetRowCellValue(e.RowHandle, gridColumnColumnInches).ToString()))
				previewText.Add(Controller.Instance.Grids.DetailedGrid.PositionColumnInchesInPreview > 0 && !previewText.Keys.Contains(Controller.Instance.Grids.DetailedGrid.PositionColumnInchesInPreview) ? Controller.Instance.Grids.DetailedGrid.PositionColumnInchesInPreview : ++maxNumber, "Total Col In: " + gridViewPublications.GetRowCellValue(e.RowHandle, gridColumnColumnInches) + " col. in.");
			if (Controller.Instance.Grids.DetailedGrid.ShowReadershipInPreview && !string.IsNullOrEmpty(gridViewPublications.GetRowCellValue(e.RowHandle, gridColumnReadership).ToString()))
				previewText.Add(Controller.Instance.Grids.DetailedGrid.PositionReadershipInPreview > 0 && !previewText.Keys.Contains(Controller.Instance.Grids.DetailedGrid.PositionReadershipInPreview) ? Controller.Instance.Grids.DetailedGrid.PositionReadershipInPreview : ++maxNumber, "Readership: " + gridViewPublications.GetRowCellValue(e.RowHandle, gridColumnReadership));
			if (Controller.Instance.Grids.DetailedGrid.ShowDeadlineInPreview && !string.IsNullOrEmpty(gridViewPublications.GetRowCellValue(e.RowHandle, gridColumnDeadline).ToString()))
				previewText.Add(Controller.Instance.Grids.DetailedGrid.PositionDeadlineInPreview > 0 && !previewText.Keys.Contains(Controller.Instance.Grids.DetailedGrid.PositionDeadlineInPreview) ? Controller.Instance.Grids.DetailedGrid.PositionDeadlineInPreview : ++maxNumber, "Deadline: " + gridViewPublications.GetRowCellValue(e.RowHandle, gridColumnDeadline));
		...
		public string DigitalLegendWebsites
		{
			get
			{
				if (!String.IsNullOrEmpty(Controller.Instance.Grids.DetailedGrid.DigitalLegend.Websites))
					return String.Format("Website: {0}", Controller.Instance.Grids.DetailedGrid.DigitalLegend.Websites);
				return String.Empty;
			}
		}
