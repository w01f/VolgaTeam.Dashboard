...
namespace Asa.Solutions.Shift.PresentationClasses.ContentEditors.ROI
{
	public partial class ROITabBControl : ChildTabBaseControl
	{
		...
		public override void ApplyChanges()
		{
			...
			SlideContainer.EditedContent.ROIState.TabB.SlideHeader = slideHeaderValue != CustomTabInfo.HeadersItems.FirstOrDefault(h => h.IsDefault) ?
				slideHeaderValue :
				null;
		...
		protected override OutputDataPackage GetOutputData()
		{
			...
			outputDataPackage.TemplateName = MasterWizardManager.Instance.SelectedWizard.GetShiftROIFile("roi_b.pptx");
