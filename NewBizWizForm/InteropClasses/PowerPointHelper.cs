...
namespace NewBizWizForm.InteropClasses
{
    public partial class PowerPointHelper
    {
        ...
        public bool Foreground
        {
            get
            {
                if (_powerPointObject != null)
                {
                    ...
                    WinAPIHelper.GetWindowThreadProcessId(_windowHandle, out _powerPointProcessID);
        ...
        public void AppendSlide(PowerPoint.Presentation sourcePresentation, int slideIndex, bool firstSlide = false)
        {
