...
namespace Asa.Solutions.Shift.PresentationClasses.ContentEditors
{
	partial class TilesTabControl
	{
		...
		{
			this.metroTilePanelMain = new DevComponents.DotNetBar.Metro.MetroTilePanel();
			...
			this.layoutControl.Controls.Add(this.metroTilePanelMain);
			...
			// 
			// 
			this.metroTilePanelMain.BackgroundStyle.Class = "MetroTilePanel";
			this.metroTilePanelMain.BackgroundStyle.CornerType = DevComponents.DotNetBar.eCornerType.Square;
			this.metroTilePanelMain.ContainerControlProcessDialogKey = true;
			this.metroTilePanelMain.DragDropSupport = true;
			this.metroTilePanelMain.LicenseKey = "F962CEC7-CD8F-4911-A9E9-CAB39962FC1F";
			this.metroTilePanelMain.Location = new System.Drawing.Point(0, 0);
			this.metroTilePanelMain.Name = "metroTilePanelMain";
			this.metroTilePanelMain.ReserveLeftSpace = false;
			this.metroTilePanelMain.Size = new System.Drawing.Size(869, 582);
			this.metroTilePanelMain.TabIndex = 4;
			this.metroTilePanelMain.Text = "metroTilePanel1";
			// 
			// layoutControlItemTiles
			// 
			this.layoutControlItemTiles.Control = this.metroTilePanelMain;
			this.layoutControlItemTiles.ControlAlignment = System.Drawing.ContentAlignment.MiddleCenter;
			this.layoutControlItemTiles.FillControlToClientArea = false;
			this.layoutControlItemTiles.Location = new System.Drawing.Point(0, 0);
			this.layoutControlItemTiles.Name = "layoutControlItemTiles";
			this.layoutControlItemTiles.Padding = new DevExpress.XtraLayout.Utils.Padding(0, 0, 0, 0);
			this.layoutControlItemTiles.Size = new System.Drawing.Size(869, 582);
			this.layoutControlItemTiles.Text = "Tiles";
			this.layoutControlItemTiles.TextSize = new System.Drawing.Size(0, 0);
			this.layoutControlItemTiles.TextVisible = false;
			this.layoutControlItemTiles.TrimClientAreaToControl = false;
			// 
			// TilesTabControl
			// 
		...
		private DevComponents.DotNetBar.Metro.MetroTilePanel metroTilePanelMain;
